...
<script language="javascript">
	function fn_imageUp() {
		...
		if(document.editor_upimage.elements['Filedata'].value.length < 1){
			alert("파일을 첨부하여 주세요 !");
			return;;
		}
	...
	function fn_imageUp5() {
		if(document.editor_upimage5.elements['Filedata'].value.length < 1){
			alert("파일을 첨부하여 주세요 !");
			return;;
		}
...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">
        ...
        <div id="pop_content2">
            ...
            <p class="dsc">파일설명 :<input type="text" class="upload" id="uploadInputFileName" name="uploadInputFileName"></p>
            <p class="dsc" id="info"><strong>등록 이미지 파일과 연관성 있는 설명으로 올려주세요</strong></p>
        </div>
		</form>
		
		<div id="pop_footer">
		    <div class="btn_area">
	            <a href="javascript:fn_imageUp();"><img src="../../img/photoQuickPopup/btn_confirm.png" width="49" height="28" alt="확인" id=""></a>
	            <a href="javascript:fn_close();"><img src="../../img/photoQuickPopup/btn_cancel.png" width="48" height="28" alt="취소" id=""></a>
	        </div>
    	</div>
        <!-- //content -->
    ...
    <div id="pop_container" class="pop_container" style="display:none;">
        ...
        <div id="pop_content2">
            ...
            <p class="dsc" id="info"><strong>10MB</strong>이하의 이미지 파일만 등록할 수 있습니다.<br>(JPG, GIF, PNG, BMP)</p>
            <p class="dsc">파일설명 :<input type="text" class="upload" id="uploadInputFileName" name="uploadInputFileName"></p>
            <p class="dsc" id="info"><strong>등록 이미지 파일과 연관성 있는 이름으로 올려주세요</strong></p>
        </div>
		</form>
		
		<div id="pop_footer">
	    <div class="btn_area">
            <a href="javascript:fn_imageUp5();"><img src="../../img/photoQuickPopup/btn_confirm.png" width="49" height="28" alt="확인" id=""></a>
            <a href="javascript:fn_close();"><img src="../../img/photoQuickPopup/btn_cancel.png" width="48" height="28" alt="취소" id=""></a>
        </div>
    </div>
        <!-- //content -->
