...
if(dom) { 
    ...
    strCalendar += "td {font-size:10px; font-family:굴림; text-decoration:none; }";
    ...
    strCalendar += "font { font-size: 7pt; }";
    ...
    strCalendar += ".cnj_input2 {font-size:7pt;color:#808080; background-color:#EFEFEF; border-width:1; border-color:#808080; border-style:solid;cursor:hand;height:16px; width:20px; padding:4px;}";
    strCalendar += ".cnj_input3 {font-size:7pt;color:#000000; background-color:#FFFFFF; border-width:1; border-color:#C00000; border-style:solid;cursor:hand;height:16px; width:20px; padding:4px;}";
    strCalendar += ".cnj_input4 {font-size:7pt;color:#C00000; background-color:#FFFFFF; border-width:1; border-color:#808080; border-style:solid;cursor:hand;height:16px;}";
    strCalendar += ".cnj_td {border-width:1;border-style:solid;border-color:#a0a0a0;}";
    strCalendar += "</style>";

    strCalendar += "<div id='calendar' style='z-index:+999;position:absolute;height;'>";
...
function init() {
    if(!ns4) {
        ...
        sHTML1+="onMouseover=\"window.status='월 선택'\" onMouseout=\"this.className='cnj_input4';window.status=''\"></span>&nbsp;";

        sHTML1+="<span id='spanYear'  class='cnj_input4' onclick='parent.popUpYear()' title='년도 선택' "
        sHTML1+="onMouseover=\"window.status='년도 선택'\" onMouseout=\"this.className='cnj_input4';window.status=''\"></span> ";
