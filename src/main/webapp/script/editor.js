...
+"<style>\n"
+"  body { color: #0f0f0f; font-family: 굴림; font-size: 9pt; font-weight: normal; }\n"
+"  table { color: #0f0f0f; font-family: 굴림; font-size: 9pt; font-weight: normal; }\n " 
+"  P {margin:0}\n" 
+"</style>\n"
+"</HEAD>\n<BODY>\n"; 
...
function OnDocumentComplete()
{
	...
	if( is_init == false )
	{
        ...
        if( document.all.edit_div.innerHTML.search( /<html>/gi ) != -1 ) {
            src = default_source.substring(0,222) + ContentsDecode(document.all.edit_div.innerHTML) + "</BODY>\n</HTML>";
        }else {
