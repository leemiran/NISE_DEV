...
<form name="form1" method="post" accept-charset="euc-kr">	
<input type="hidden" name="p_nGubun" value="<%=p_nGubun %>">
  <tr>
  ...
  <tr> 
	...
	<tr>
		...
		<td width="263">
          ...
          <tr>
            <td height="28">
            <input name="jumin1" type="text"  maxlength=6 style='width:68;font-size:9pt;height:18' class="input_textfield"  onkeyup="nextFocus('form1','jumin1','jumin2')"> - 
            <input name="jumin2" type="password" maxlength=7  style='width:100;font-size:9pt;height:18' class="input_textfield" onkeyup="nextFocus('form1','jumin2','name')"></td>
          </tr>
          <tr>
