...
<%
    ...
    String sReturnUrl = "http://localhost:8080/usr/mem/checkPlusSafeSuccess.do";      // 성공시 이동될 URL
    String sErrorUrl = "http://localhost:8080/usr/mem/checkPlusSafeFail.do";          // 실패시 이동될 URL
