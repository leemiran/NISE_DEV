...
<c:choose>
	...
	<c:when test="${resultMap.msgChk eq 'Y' }">
		...
		window.onload = function () {
		    ...
		    document.resIPinFrm.target = "parentPage"; // 타켓을 부모창으로 설정 "_top"; // "_self"; //
		    document.resIPinFrm.action = "${pageContext.request.contextPath}${retUrl}";
		    document.resIPinFrm.submit();
		    self.close();
		...
		<form name="resIPinFrm" method="post">
			<c:choose>
