...
<form name="<c:out value="${gsMainForm}"/>" id="<c:out value="${gsMainForm}"/>" method="post" action="">
    ...
    <div class="tbDetail">    
		...
		<thead>
			<tr>
				<th scope="row" style="text-align: center;">유치원교원</th>
				<th scope="row" style="text-align: center;">초등교원</th>
				<th scope="row" style="text-align: center;">중등교원</th>
				<th scope="row" style="text-align: center;">유치원교원(특수)</th>
				<th scope="row" style="text-align: center;">초등교원(특수)</th>
				<th scope="row" style="text-align: center;">중등교원(특수)</th>
		...
		<tbody>
			<c:forEach items="${resultList}" var="result" varStatus="status">
				<tr>
					...
					<td style="text-align: center;"><fmt:formatNumber value="${result.code6}" groupingUsed="true"/></td>
					<td style="text-align: center;"><fmt:formatNumber value="${result.code7}" groupingUsed="true"/></td>
					<td style="text-align: center;"><fmt:formatNumber value="${result.code8}" groupingUsed="true"/></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
...
function chart() {
	...
	pData = google.visualization.arrayToDataTable([
		['Element', '회원', { role: 'style' }, { role: 'annotation' } ],
		['유치원교원', Number(map.get("code1"))	, '#550000', map.get("code1") ],
		['초등교원', Number(map.get("code2"))	, '#005500', map.get("code2") ],
		['중등교원', Number(map.get("code3"))	, '#000055', map.get("code3") ],
		['유치원교원(특수)', Number(map.get("code4"))	, '#aa0000', map.get("code4") ],
		['초등교원(특수)', Number(map.get("code5"))	, '#00aa00', map.get("code5") ],
		['중등교원(특수)', Number(map.get("code6"))	, '#0000aa', map.get("code6") ],	                                                  
		['교감', Number(map.get("code7"))	, '#550000', map.get("code7") ],
		['교장', Number(map.get("code8"))	, '#005500', map.get("code8") ],
	]);
}
