...
<div id="popwrapper">
	<div class="popIn">
		...
		<div class="list">	
			<div class="btnR"><a href="#" class="btn01" onclick="javascript:doDownloadSample('module_upload.xls')"><span>Module 엑셀샘플</span></a></div>
		</div>
		<br/>
		<!-- contents -->
		<div class="popCon">
				...
				<tbody>
					...
					<tr>
						<td style="padding-left:10px;" colspan="2">
							<img src="/images/adm/sample/module_manual.png" border="0" style="width:99%">
						</td>
					</tr>
				</tbody>
			</table>
...
<script type="text/javascript">
	...
	function upload(){
		...
		frm.action = "/adm/lcms/old/moduleUpload.do";
		frm.target = "_self";
		frm.submit();
	}
