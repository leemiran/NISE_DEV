...
<form name="<c:out value="${gsMainForm}"/>" id="<c:out value="${gsMainForm}"/>" method="post" action="">
	...
	<div class="listTop">
		<div class="btnR"><a href="/adm/lcms/old/oldContentList.do?s_menu=29000000&s_submenu=29010000" class="btn01"><span>콘텐츠관리</span></a></div>
	</div>
...
<script type="text/javascript">
	...
	function doPageList() {
		...
		frm.action = "/adm/lcms/old/practiceStudyList.do";
		frm.target = "_self";
		frm.submit();
	}
	...
	function subList(subj) {
		var frm = eval('document.<c:out value="${gsMainForm}"/>');
		frm.action = "/adm/lcms/old/practiceStudySubList.do";
