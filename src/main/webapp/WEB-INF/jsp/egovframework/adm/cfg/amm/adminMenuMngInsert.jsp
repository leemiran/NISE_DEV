...
<%@ include file="/WEB-INF/jsp/egovframework/adm/com/admCommonHidden.jsp"%>
	...
	<div class="listTop">			
		...
		<div class="btnR"><a href="#" class="btn01" onclick="insert()"><span>저장</span></a></div>
	</div>
    ...
    <div class="tbDetail">
        <table summary="" cellspacing="0" width="100%">
            ...
            <c:if test="${p_levels > 1}">
                ...
                <tr class="title">
                    <th>메뉴코드명</th>
                    <td><input type="text" name="p_menunm"  id="p_menunm" /></td>
                </tr>
                <tr class="title">
                    <th>관련 Program</th>
                    <td><input type="text" name="p_pgm"  id="p_pgm" style="width:95%"/></td>
                </tr>
                <tr class="title">
                    <th>Parameter</th>
                    <td>
                    	<input type="text" name="p_para1"  id="p_para1"  />&
                    	<input type="text" name="p_para2"  id="p_para2"  />&
                    	<input type="text" name="p_para3"  id="p_para3"  />&
                    	<input type="text" name="p_para4"  id="p_para4"  />&
                    	<input type="text" name="p_para5"  id="p_para5"  />&
                    	<input type="text" name="p_para6"  id="p_para6"  />&
                    	<input type="text" name="p_para7"  id="p_para7"  />&
                    	<input type="text" name="p_para8"  id="p_para8"  />&
                    	<input type="text" name="p_para9"  id="p_para9"  />&
                    	<input type="text" name="p_para10" id="p_para10" />&
                    	<input type="text" name="p_para11" id="p_para11" />&
                    	<input type="text" name="p_para12" id="p_para12" />&
                    </td>
                </tr>
                <tr class="title">
                    <th>메뉴순서</th>
                    <td><input type="text" name="p_orders" id="p_orders"/></td>
                </tr>
                <tr class="title">
                    <th>사용여부</th>
                    <td>
                    	<input type="radio" id="p_isdisplay" name="p_isdisplay" value="Y" checked/> 사용
                    	<input type="radio" id="p_isdisplay" name="p_isdisplay" value="N"/> 미사용
                    </td>
                </tr>
            </tbody>
        </table>				
...
<script type="text/javascript">
	...
	function insert(){
        ...
        frm.action = "/adm/cfg/amm/adminMenuMngInsert.do";
        frm.submit();
	}
</script>