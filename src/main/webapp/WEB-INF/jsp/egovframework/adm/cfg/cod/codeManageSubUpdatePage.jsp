    ...
    <div class="tbDetail">
        <table summary="" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <tr class="title">
                    <th>소분류코드명</th>
                    <td><input type="text" id="p_codenm" name="p_codenm" value="<c:out value="${subView.codenm}"/>" style="width:90%;ime-mode:active" onfocus="this.select"></td>
                </tr>
            </tbody>
        </table>				
    </div>
...
<script type="text/javascript">
	...
	function updateData(){
		...
		frm.action = "/adm/cfg/cod/codeManageSubUpdate.do"
		frm.submit();
	}
