...
<c:if test="${not empty p_seq}">
                        ...
                        <tr>
                            <th scope="row">제목</th>
                            <td scope="row"><input size="80" maxlength="100" name="p_title" value = "<c:out value="${view.title}" escapeXml="true" />"></td>
                        </tr>
                        <tr>
                            <th scope="row">내용</th>
                            <td scope="row">
                            <textarea rows="10" cols="80" name="p_content"><c:out value="${view.content}" escapeXml="true" /></textarea>
                            </td>
                        </tr>
...
<script type="text/javascript">
	...
	function whenAction(mode) {
		...
		if (confirm(msg + "")) {
			thisForm.action = "/adm/hom/qna/selectQnaAction.do";
