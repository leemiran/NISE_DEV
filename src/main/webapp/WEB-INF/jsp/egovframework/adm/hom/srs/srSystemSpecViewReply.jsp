...
<%@ include file="/WEB-INF/jsp/egovframework/adm/com/admCommonHidden.jsp"%>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding-left:0px" scope="row"  colspan="3">
						<textarea name="req_content" id="req_content" rows="10" cols="100" style="width:100%; height:412px; display:none;">${viewlist.reqContent}</textarea>
	...
	<div class="listTop">			
		...
		<c:if test="${empty viewlist}">		
			<div class="btnR"><a href="#none" class="btn02" onclick="whenNoticeSave('reinsert')"><span>답변등록</span></a></div>
		</c:if>	
		<c:if test="${!empty viewlist}">		
			<div class="btnR"><a href="#" class="btn02" onclick="whenNoticeSave('reupdate','${viewlist.reSeq}')"><span>답변수정</span></a></div>
		</c:if>	
