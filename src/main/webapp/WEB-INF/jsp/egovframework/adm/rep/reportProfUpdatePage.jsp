...
<%@ include file="/WEB-INF/jsp/egovframework/adm/com/admCommonHidden.jsp"%>
	...
	<div class="listTop">			
		...
		<div class="btnR"><a href="#" class="btn01" onclick="insertData()"><span>수정</span></a></div>
	</div>
    ...
    <div class="tbDetail">
        <table summary="" cellspacing="0" width="100%">
            ...
            <tbody>
                <tr class="title">
                    <th>제목</th>
                    <td><input name="p_title" type="text" class="input" size="80" value="${view.title}"/></td>
                </tr>
                <tr>
                    <th>만점</th>
...
<script type="text/javascript">
	...
	function insertData(){
		...
		frm.action = "/adm/rep/reportProfUpdateData.do";
		frm.target = "_self";
		frm.submit();
	}
