        ...
        <table summary="" cellspacing="0" width="100%">
            ...
            <tbody>
                <tr class="title">
                    ...
                    <td>
                    	...
                    	<c:forEach items="${dicgroup}" var="result">
                    		<option value="${result.groups}" <c:if test="${data.groups eq result.groups}">selected</c:if>>${result.groups}</option>
                    	</c:forEach>
                    	</select>
                    </td>
                </tr>
                <tr class="title">
                    <th>용어</th>
                    <td>
                    	<input type="text" id="p_words" name="p_words" style="width:95%" value="${data.words}">
                    </td>
                </tr>
                <tr class="title">
                    <th>설명</th>
                    <td style="padding-left:0px">
                    	<c:set var="content" value="${data.descs}"/>
...
<script type="text/javascript">
	...
	function updateData(){
		...
		frm.action = "/adm/cmg/ter/termDictionaryUpdate.do"
		frm.submit();
	}
