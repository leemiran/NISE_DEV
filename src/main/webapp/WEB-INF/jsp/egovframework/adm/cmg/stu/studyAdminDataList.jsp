		...
		<table summary="" cellspacing="0" width="100%">
			...
			<c:forEach items="${list}" var="result" varStatus="i">
				<tr>
					...
					<td>${result.cnt}</td>
					<td>
						<a href="#none" class="btn01" onclick="doDataBoardList('${result.subj}', '${result.year}', '${result.subjseq}', '${result.subjnm}', '${result.tabseq}')"><span>자료실리스트</span></a>
					</td>
				</tr>
			</c:forEach>
