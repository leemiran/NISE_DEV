...
String realFileName = "수강현황_" + session.getAttribute("ses_search_subjinfo"); 
//response.reset();
...
<body bgcolor="#FFFFFF" text="#000000" topmargin="0" leftmargin="0">
    ...
    <div class="tbDetail">
        <table summary="" cellspacing="0"  width="1800" border=1 >
                <caption class="tbleft">수강현황</caption>
                <colgroup>
                	<col width="15%" />
                	<col width="*" />
            	</colgroup>
            <tbody>
                <tr>
                    ...
                    <td style="height:30px;text-align:left; padding-left: 20px;" colspan="17">${view.subjnm} - ${view.subjseq}기</td>
                </tr>
                <tr class="title">
                    <th  class="tbtitlecenter" >연수기간</th>
                    <td style="text-align:left; padding-left: 20px;" colspan="17"><c:out value="${fn2:getFormatDate(view.edustart, 'yyyy년 MM월 dd일')}"/>&nbsp;&nbsp;&nbsp;~&nbsp;&nbsp;&nbsp;<c:out value="${fn2:getFormatDate(view.eduend, 'MM월 dd일')}"/></td>
                </tr>
                <tr class="title">
                    <th  class="tbtitlecenter" >이수시간 및 학점</th>
                    <td style="text-align:left; padding-left: 20px;" colspan="17">${view.edutimes}시간 (${view.point}학점)</td>
                </tr>
                <tr class="title">
                    <th  class="tbtitlecenter" >수강인원</th>
                    <td style="text-align:left; padding-left: 20px;" colspan="17">${view.studentTotalCnt} 명</td>
                </tr>
                <tr >
                    <th class="tbtitlecenter" >이수인원</th>
                    <td style="text-align:left; padding-left: 20px;" colspan="17"><c:out value="${view.isgraduatedY}"/> 명</td>
                </tr>
                <tr class="title">
                    <th  class="tbtitlecenter" >미이수인원</th>
                    <td style="text-align:left; padding-left: 20px;" colspan="17"><c:out value="${view.isgraduatedN}"/> 명</td>
                </tr>
               <!-- 20180425 주석 -->
               <%-- 
                <tr>
                    <th  class="tbtitlecenter" >납부구분</th>
                    <td align="center" style="padding:2px" colspan="19">                 
	                    <c:choose>                    	
                ...
                <tr class="title">
                    <th class="tbtitlecenter" >연수구분</th>
                    <td style="text-align:left; padding-left: 20px;" colspan="19">
                    1.자격연수 2.직무연수 3.특별연수 4.교양연수
                    <c:out value=""/>     
                    </td>
                </tr> --%>
            </tbody>
			...
			<table summary="" cellspacing="0" width="1800" border="1" style="margin-top: 10px">
				...
				<thead>
					<tr class="tbtitlecenter">
						...
						<th scope="row">회원<br>구분</th>
						<th scope="row">생년월일</th>
						
						<th scope="row">소속</th>
						
						<th scope="row">성명</th>
						<th scope="row">NEIS개인번호</th>
						<!-- <th scope="row">연수지명번호</th> -->
						
						<th scope="row">연수과정명</th>
						<th scope="row">연수기관명</th>
						<th scope="row">연수<br>시작일</th>
						<th scope="row">연수<br>종료일</th>
						<th scope="row">연수<br>구분</th>
						
						<th scope="row">연수<br>시간</th>
						<th scope="row">연수<br>성적</th>
						<!-- <th scope="row">직무<br>관련</th> -->
						<th scope="row">학점</th>
