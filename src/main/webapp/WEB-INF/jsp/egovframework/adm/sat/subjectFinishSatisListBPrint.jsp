...
String ischargeNm 		= request.getParameter("print_ischargeNm")+"";
String upperclassNm 		= request.getParameter("print_upperclassNm")+"";
...
%>
<c:set var="rf" value="subjectFinishSatisListBPrint.mrd"/>
<c:set var="rv"></c:set>
<c:set var="rp">
	...
	[<c:out value="<%=ischargeNm%>"  		escapeXml="false"/>] 
	[<c:out value="<%=upperclassNm%>"  	escapeXml="false"/>] 
...
System.out.println("ischargeNm["+ischargeNm+"]");
System.out.println("upperclassNm["+upperclassNm+"]");
