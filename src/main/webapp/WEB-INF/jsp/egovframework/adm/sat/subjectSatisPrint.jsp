...
<c:set var="rf" value="subjectHab.mrd"/>
<c:set var="rv"></c:set>
<c:set var="rp">
	[<c:out value="${ses_search_grseq}"  escapeXml="false"/>] 
	...
	[<c:out value="${ses_search_subjseqr}"  escapeXml="false"/>] 
	[<c:out value="${ses_search_year}"  escapeXml="false"/>] 
