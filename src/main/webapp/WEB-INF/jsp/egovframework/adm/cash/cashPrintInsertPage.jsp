...
<%@ include file="/WEB-INF/jsp/egovframework/adm/com/admCommonHidden.jsp"%>
    	...
    	<td background="/images/cert/bg_line.gif" style="padding: 0px 6px 0 6px;">
            ...
            <colgroup>
        		...
        		<tr> 
          			...
          			<td class="left last"><input type="text" name="p_org_name" id="p_org_name" value="" /></td>
        		</tr>
        		<tr> 
          			<th scope="col" width="70" style="text-align:left;">연 수 대 상 자 : </th>
          			<td class="left last">
          				<input type="text" name="p_uname" id="p_uname" value="" size="80"/>
          			</td>
        		</tr>
        		<tr> 
          			<th scope="col" width="70" style="text-align:left;">과&nbsp;&nbsp;&nbsp;정 &nbsp;&nbsp;&nbsp;명 : </th>
          			<td class="left last"><input type="text" name="p_subj_nm" id="p_subj_nm" value="" size="80"/></td>
        		</tr>
        		<tr> 
          			<th scope="col" width="70" style="text-align:left;">연&nbsp;수&nbsp;종&nbsp;별 : </th>
          			<td class="left last">
          				<input type="text" name="p_yonsu_name" id="p_yonsu_name" value="" />
          			</td>
        		</tr>
        		<tr> 
          			<th scope="col" width="70" style="text-align:left;">금&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;액 : </th>
          			<td class="left last"><input type="text" name="p_amount" id="p_amount" value=""/>원(면세) (숫자만 넣으세요.)</td>
        		</tr>
        		<tr> 
          			<th scope="col" width="70" style="text-align:left;">입&nbsp;&nbsp;&nbsp;금&nbsp;&nbsp;&nbsp;일 : </th>
          			<td class="left last"><input type="text" name="p_amount_date" id="p_amount_date" value="" maxlength="8"/>(예: 20150412)</td>
        		</tr>
      		</table> 
      	</td>
  	</tr>
    ...
    <!-- // search wrap -->
	<center>			
		<a href="#" class="btn02" onclick="whenCashPrintSave('insert')"><span>저장</span></a>
	</center>
    <!-- // detail wrap -->
</form>
...
<script type="text/javascript">
	...
	function whenCashPrintSave(mode) {
		...
		if(thisForm.p_amount.value * 0 != 0 ){
			alert("숫자만 입력가능합니다.");
			thisForm.p_amount.value = "";
			thisForm.p_amount.focus();
			return false;
		}
		...
		if(thisForm.p_amount_date.value * 0 != 0 ){
			alert("숫자만 입력가능합니다.");
			thisForm.p_amount_date.value = "";
			thisForm.p_amount_date.focus();
			return false;
		}
