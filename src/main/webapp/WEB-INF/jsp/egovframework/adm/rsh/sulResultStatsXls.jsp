...
<% 
	String realFileName = "설문조사 시스템 전체설문결과분석_" + session.getAttribute("ses_search_subjinfo"); 
	//response.reset();
...
<body bgcolor="#FFFFFF" text="#000000" topmargin="0" leftmargin="0">
		...
		<div class="sub_tit">
			<h4 id="sulScoreTotalH4">총응답자수 : <%=v_replycount%>명</h4>	
		</div>
		...
		<div class="tbList">
		  <table summary="" cellspacing="0" border="1" width="100%">
	        ...
	        <thead>
		      <tr>
		        <th class="xl26">평균</th>
		        <th class="xl26">표준편차</th>
		        <th class="xl26">1분위</th>
		        <th class="xl26">2분위</th>
		        <th class="xl26">3분위</th>
		        <th class="xl26">4분위</th>
		        <th class="xl26">최소값</th>
		        <th class="xl26">최대값</th>
	          </tr>
	        </thead>
	        <tbody>	
		      <tr>
