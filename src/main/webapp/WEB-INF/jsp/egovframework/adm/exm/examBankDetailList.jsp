...
<div id="popwrapper">
	<div class="popIn">
		...
		<ul class="btnCen">			
			<li>
				<a href="#" class="pop_btn01" onclick="examPriview()"><span>문제 미리보기</span></a>
		...
		<div class="tbList">
			...
			<c:forEach items="${list}" var="result" varStatus="status">
				<tr style="cursor:pointer" onmouseover="overRow(this);">
					...
					<td><c:out value="${result.lessonnum}"/></td>
...
function doView(p_subj, p_examnum) {	
     farwindow = window.open("", "examBankViewPopWindow", "toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no, width = 800, height = 700, top=0, left=0");
     $("#p_subj").val(p_subj);
     $("#p_examnum").val(p_examnum);
     thisForm.target = "examBankViewPopWindow"
