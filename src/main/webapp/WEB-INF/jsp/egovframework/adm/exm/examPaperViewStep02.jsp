...
%>
                ...
                <table summary="" width="100%" class="popTb">
                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <td>1문제당 
                          <input name="p_exampoint" type="text" class="input" size="5" value="<fmt:formatNumber value="${paperView.exampoint}" type="number"/>"> 점</td>
                          <th>문제수</th>
                          <td><input name="p_examcnt" type="text" class="input" size="5" value="${paperView.examcnt}"> 개문제출제</td>
                        </tr>
		...
		<ul class="btnCen">
			...
			<c:if test="${paperCnt == 0}">
				<li><a href="javascript:PaperAction('update')" class="pop_btn01"><span>저 장</span></a></li>
			</c:if>
			
			
			</c:if>
			<c:if test="${empty view}">
				<li><a href="javascript:PaperAction('insert')" class="pop_btn01"><span>저 장</span></a></li> 
			</c:if>
