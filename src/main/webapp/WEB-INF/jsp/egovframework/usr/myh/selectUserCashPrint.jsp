  	...
  	<tr> 
    	<td background="/images/cert/bg_line.gif" style="padding: 0px 6px 0 6px;">
            ...
            <colgroup>
        		...
        		<tr> 
          			<th scope="col" width="70" class="left">성&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;명</th>
          			<td class="left last">${view.uname}</td>
        		</tr>
        		<tr> 
          			<th scope="col" width="70" class="left">소&nbsp;속&nbsp;학&nbsp;교</th>
          			<td class="left last">${view.upass}</td>
        		</tr>
        		<tr> 
          			<th scope="col" width="70" class="left">과&nbsp;&nbsp;&nbsp;정 &nbsp;&nbsp;&nbsp;명</th>
          			<td class="left last">${view.subjnm}</td>
        		</tr>
        		<tr> 
          			<th scope="col" width="70" class="left">연&nbsp;수&nbsp;종&nbsp;별</th>
          			<td class="left last">
          			<c:choose>
          				<c:when test="${view.subjclassnm eq 'EXT'}">
          					특수교육보조인력 직무연수
          				</c:when>
          				<c:when test="${view.subjclassnm eq 'PRF'}">
          					직무연수
          				</c:when>
          				<c:otherwise>
          					일반연수
        		...
        		<tr> 
          			<th scope="col" width="70" class="left">금&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;액</th>
          			<td class="left last"><fmt:formatNumber value="${view.biyong}" type="number"/>원(면세)</td>
        		</tr>
        		<tr> 
          			<th scope="col" width="70" class="left">수 강 신 청 일</th>
          			<td class="left last">${fn2:getFormatDate(view.appdate, 'yyyy.MM.dd')}</td>
        		</tr>
      		</table>
      	</td>
  	</tr>
