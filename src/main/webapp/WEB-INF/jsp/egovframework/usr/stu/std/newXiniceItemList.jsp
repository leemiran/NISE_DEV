						...
						<c:if test="${result.module != oldModule}">
							<tr>
								<td class="left">
									...
									<a href="#none"title="새창" onclick="doStudyPopup('<c:out value="${result.module}"/>', '<c:out value="${result.lesson}"/>');">
								...
								<td>
				                	...
				                	<c:if test="${ esult.lessonCnt != result.studyCnt and result.incomplete ne '0' }">
				                	<img src="/images/adm/btn/btn_my04.gif" alt="학습중" />
				                	</c:if>
