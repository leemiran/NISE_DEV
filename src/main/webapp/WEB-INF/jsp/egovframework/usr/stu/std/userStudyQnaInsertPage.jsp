		...
		<div class="popCon">
			...
			<div class="mycon">
				...
				<input type="hidden" name="pageIndex" 	id="pageIndex"	value="${pageIndex}">
					<h4 class="tit">Q&amp;A</h4>
					<div class="tbDetail">
						<table summary="작성자, 제목, 공개여부, 내용, 첨부파일로 구성" cellspacing="0" width="100%">
							<caption>Q&amp;A</caption>
							<colgroup>
								<col width="18%" /> 
								<col width="" />
							...
							<tbody>
								...
								<tr class="title">
									<th scope="col">제목</th>
									<td>
										<input type="text" name="p_title" id="p_title"  class="inputTitle" maxlength="200" style="width:98%" title="제목"/>
									</td>
								</tr>
								<tr class="title">
									<th scope="col">공개여부</th>
									<td>
									  <input type="radio" name="p_isopen" id="p_isopen2"  class="btnBorder" value="Y" checked /><label for="p_isopen2">공개</label> 
									  <input type="radio" name="p_isopen" id="p_isopen1"  class="btnBorder" value="N" /> <label for="p_isopen1">비공개(비공개 선택시 운영자와 강사 그리고 작성자만 볼 수 있습니다.)</label>
									</td>
								</tr>
								<tr class="title">
									<th scope="col">내용</th>
...
<script type="text/javascript">
	...
	function insertData(){
		...
		frm.action = "/usr/stu/std/userStudyQnaInsert.do";
		frm.target = "_self";
		frm.submit();
	}
	document.title="질문방(쓰기) : 나의 강의실 : 국립특수교육원부설원격교육연수원";
</script>
