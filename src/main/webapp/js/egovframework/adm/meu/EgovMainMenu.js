...
var imgpath         = "/images/egovframework/adm/meu/";
var treeYeobu       = false;
var chkValue        = "";
var vHtmlCode       = "";
...
function createTree(arrName, vYeobu, checkValue) {
   var startNode, openNode;
	...
	if (treeNodes.length > 0) {
		...
		vHtmlCode +="<td valign='bottom' background='/images/egovframework/adm/meu/left_menu_top.gif' style='background-repeat:no-repeat'>";
		...
		vHtmlCode +="<tr><td height='30' valign='bottom' background='/images/egovframework/adm/meu/left_menu_btm.gif' style='background-repeat:no-repeat'>&nbsp;</td></tr></table>";
