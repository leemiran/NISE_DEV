...
var imgpath         = "/images/egovframework/cmm/utl/";
var vHtmlCode       = "";
	...
	for (var i = 0; i < treeNodes.length; i++) {
		...
		if (nodeValues[1] == parentNode) {
			...
			if (hasChildNode){
				...
				vHtmlCode +="<img src='"+imgpath+"menu_empty.gif' border='0' align='absbottom' alt='' >";
				vHtmlCode +="<font size=2 class='.location'><a href=javascript:fCallUrl('" + nodeValues[4] + "');>― "+nodeValues[2]+"</a></font><br> \n";
            }
			if (hasChildNode) {
 ...
 * JSP코드 편집
 ******************************************************** */
function fHtmlCreat_Head(){
	HtmlHead ='<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8"%>\n'
	    +'<DIV id="main" style="display:"> \n';
	HtmlBottom='</DIV>\n';
	vHtmlCode = HtmlHead+vHtmlCode+HtmlBottom;
}
