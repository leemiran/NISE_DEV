...
<form name="login" action="JUpdateStep2.jsp" method="post">
...
<table border="0" cellspacing=1 cellpadding=0 height=294 width="680">
  ...
  <td height="321" width="625">
            ...
            <tr>
            <td colspan=3 width="589"><font size="4" color="blue">&nbsp;<%= Message.get("jupdatestep1_01") %></font><hr>            <p>&nbsp;&nbsp;<%= Message.get("jupdatestep1_02") %></font></p>
            <p>&nbsp;&nbsp;<%= Message.get("jupdatestep1_03") %></font></p>
                        <p>&nbsp;&nbsp;<%= Message.get("jupdatestep1_04") %></font></p>
<hr></td>
<td width="1">
&nbsp;                    </td>
            </tr>
...
<%
   {
      ...
      btnadd.printButton(75,280,"envup",170,6, "<b><font size=2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+Message.get("jupdatestep1_05")+"</b></font>"  ,"javascript:login.submit();","images/arrow_right.gif",28);
   }
