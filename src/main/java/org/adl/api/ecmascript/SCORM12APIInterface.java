 ...
 *	 state and that any additional API calls may or may not be processed by the 
 *  LMS.
 */
 ...
 *   <ul>
 *    <li>	Values for various categories (groups) 
 *           and elements in the data model</li>
 ...
 *       representing the current value of the requested element or group.</li>
 ...
 *       if the element is not supported.  The error "401 Not implemented error" 
 *	      indicates the element is not supported.</li>
