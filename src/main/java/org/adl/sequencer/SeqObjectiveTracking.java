...
public class SeqObjectiveTracking implements Serializable
{
    ...
    */
   /* package */
   void forceObjStatus(String iSatisfied) throws AOFException
   {
    ...
    */
   /* package */
   void setObjStatus(String iSatisfied) throws AOFException
   {
    ...
    */
   /* package */
   boolean clearObjStatus() throws AOFException
   {
    ...
    */
   /* package */
   boolean clearObjMeasure(boolean iAffectSatisfaction) throws AOFException
   {
    ...
    */
   /* package */
   void setObjMeasure(double iMeasure, boolean iAffectSatisfaction) throws AOFException             
   {
    ...
    */
   /* package */
   String getObjStatus(boolean iIsRetry)throws AOFException
   {
    ...
    */
   /* package */
   String getObjStatus(boolean iIsRetry, boolean iUseLocal)throws AOFException
   {
      if ( _Debug )
      {
         System.out.println("  :: SeqObjectiveTracking   --> BEGIN - " + 
    ...
    */
   /* package */
   String getObjMeasure(boolean iIsRetry)throws AOFException
   {
    ...
    */
   /* package */
   String getObjMeasure(boolean iIsRetry, boolean iUseLocal)throws AOFException
   {
