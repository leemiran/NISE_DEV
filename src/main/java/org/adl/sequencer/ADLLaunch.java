 ...
 * RTE 1.3.1 uses the information to determine the result of the signaled
 * navigation event and to launch any content object selected by the
 * <code>ADLSequencer</code>.<br><br> It also provides information to the RTE
 * concerning, errors, set of available auxilary resources, and the currently 
 * valid navigation requests.<br><br>
 * 
 * <strong>Design Issues:</strong><br>
 * This implementation is intended to be used by the SCORM Sample RTE 1.3.1.<br>
 * <br>
 * 
 ...
 */ 
public class ADLLaunch implements Serializable
{
   /**
   ...
   public void dumpState()
   {
      if ( _Debug )
      {
         ...
         if ( mServices != null )
         {
            ...
            Enumeration enume = mServices.keys();

            while ( enume.hasMoreElements() )
            {
               temp = (ADLAuxiliaryResource)mServices.get(enume.nextElement());
               temp.dumpState();
            }
         }
/*
