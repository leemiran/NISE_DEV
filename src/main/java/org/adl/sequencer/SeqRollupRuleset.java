...
public class SeqRollupRuleset implements Serializable
{
    ...
    * 
    * @param iMinMeasure
    *                    Minimum measure required for the activity's objective
    *                    to be satisfied.
    * 
    * @param iChildren   Set of activities (<code>SeqActivity</code>) used to
    *                    evaluate the set of rollup rules.
    * 
    ...
    * 
    * @return <code>true</code> if evaluation of rollup rules for this activity
    *         resulted in a state change, otherwise <code>false</code>.
    */
      ...
      if ( ioThisActivity != null )
      {
         ...
         if ( ioThisActivity.getChildren(false) != null )
         {
            ...
            if ( !satisfiedRule )
            {
               ...
               SeqConditionSet set = new SeqConditionSet();
            ...
            if ( !ioThisActivity.getObjSatisfiedByMeasure() )
            {
               ...
               {
                  ioThisActivity.setObjSatisfied(ADLTracking.TRACK_UNKNOWN);
               }
            }
            ...
            {
               ioThisActivity.setProgress(ADLTracking.TRACK_UNKNOWN);
            }
         }
         else
         {
