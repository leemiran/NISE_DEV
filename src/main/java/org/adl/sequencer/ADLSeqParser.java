 ...
 * 
 * <strong>Filename:</strong> ADLSeqParser.java<br>
 * 
 ...
 */
public class ADLSeqParser extends DOMParser implements Serializable
{
   /**
    ...
    * default <code><organization</code> element.  This element will be used
    * to construct an activity tree for this course.
    * 
    * @return The default <code><organization></code> element of the CP, or
   ...
   /**
    * Retrieves the <code><sequencingCollection></code> node, if one exists.
    * 
