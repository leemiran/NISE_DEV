 ...
 * <br><br>
 * 
 * <strong>Filename:</strong> Count.java<br><br>
 * 
 * <strong>Description:</strong><br>
 * Encapsulates the _count keyword datamodel element defined in SCORM 1.2
 ...
 */
public class Count extends DMElement implements Serializable
{
   /**
   ...
   /**
    * Constructs a <code>_count</code> keyword data model element describing the
    * number of sub-elements being maintained by the parent data model element.
    */
