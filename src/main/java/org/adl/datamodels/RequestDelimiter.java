 ...
 */
public class RequestDelimiter implements Serializable
{
   ...
   /**
    * Creates one delimter from a dot-notation bound data model request.
    * 
    ...
    *                   If the data is omitted.
    * @exception IllegalArgumentException
    *                   If the element name or value is improperly formatted.
    */
