...
/**
 * Provides support for the Duration data type, as defined in the 
 * SCORM 2004 RTE Book<br><br>
 * 
 * <strong>Filename:</strong> DurationValidator.java <br><br>
 * 
 * <strong>Description:</strong> The DurationValidator<br><br>
 * 
...
public class DurationValidator extends DMTypeValidator implements Serializable
{
   ...
   /**
    * Provides the number of seconds represented by the given duration.<br>
