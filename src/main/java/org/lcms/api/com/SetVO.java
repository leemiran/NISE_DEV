...
public class SetVO{
    ...
    public SetVO(Object obj, HttpServletRequest req) throws ClassNotFoundException {
        cls = obj.getClass();
        this.obj = obj;
        this.req = req;
    ...
    public SetVO(Object obj, MultipartRequest multi) throws ClassNotFoundException {
        cls = obj.getClass();
        this.obj = obj;
        this.multi = multi;
        ...
        if(initValue != null){
            try{
                if(fieldType == Integer.TYPE){
                    ...
                    java.util.Date dt = Util.stringToDate(initValue, "yyyy'-'MM'-'dd");
