...
public class EgovFileMngServiceImpl extends EgovAbstractServiceImpl implements EgovFileMngService {
     ...
     */
    @SuppressWarnings("unchecked")
    public String insertFileInfsPortal(List fvoList) throws Exception {
	String atchFileId = "";
	
	if (fvoList.size() != 0) {
	    atchFileId = fileMngDAO.insertFileInfsPortal(fvoList);
	}
     ...
     * @see egovframework.com.cmm.service.EgovFileMngService#selectFileInfs(egovframework.com.cmm.service.FileVO)
     */
    public List<FileVO> selectFileInfsPortal(FileVO fvo) throws Exception {
	return fileMngDAO.selectFileInfsPortal(fvo);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public void updateFileInfsPortal(List fvoList) throws Exception {
	//Delete & Insert
	fileMngDAO.updateFileInfsPortal(fvoList);
    }
	...
	fileMngDAO.deleteFileInfPortal(fvo);
    }
	...
	return fileMngDAO.selectFileInfPortal(fvo);
    }
    ...
    public int getCountFileSN(FileVO fvo) throws Exception {
    	return fileMngDAO.getCountFileSN(fvo);
    }
