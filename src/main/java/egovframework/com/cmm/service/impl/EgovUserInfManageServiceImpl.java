...
import egovframework.com.cmm.service.EgovUserInfManageService;
...
public class EgovUserInfManageServiceImpl extends EgovAbstractServiceImpl implements EgovUserInfManageService {
     ...
     */
    public Map<String, Object> selectClubOprtrList(Map<String, Object> userVO) throws Exception {
     ...
     */
    public Map<String, Object> selectClubUserList(Map<String, Object> userVO) throws Exception {
     ...
     */
    public Map<String, Object> selectCmmntyMngrList(Map<String, Object> userVO) throws Exception {
     ...
     */
    public Map<String, Object> selectCmmntyUserList(Map<String, Object> userVO) throws Exception {
     ...
     */
    public Map<String, Object> selectUserList(Map<String, Object> userVO) throws Exception {
