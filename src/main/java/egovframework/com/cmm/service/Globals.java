...
public class Globals {
    ...
    //관리자 메인 페이지
    public static final String ADM_MAIN_PAGE = EgovProperties.getProperty("Globals.AdmMainPage");
    //관리자메인 사이버 페이지
    public static final String ADM_CYBER_MAIN_PAGE = EgovProperties.getProperty("Globals.AdmCyberMainPage");    
    //메인 페이지
	...
	// 컨텐츠경로
	public static final String CONTENT_PATH = EgovProperties.getProperty("Globals.contentPath");
	// 컨텐츠실제경로
	public static final String CONTNET_REAL_PATH = EgovProperties.getProperty("Globals.contentRealPath");
	
	public static final String ADDED_OPTIONS = EgovProperties.getProperty("Globals.addedOptions");
	
	public static final String MANIFEST_PATH = EgovProperties.getProperty("Globals.manifestPath");
	
	public static final String LOGIN_EXCEPT_VALUE = EgovProperties.getProperty("Globals.loginExceptValue");
	
	public static final String LOGIN_EXCEPT_ISUSE = EgovProperties.getProperty("Globals.loginExceptIsuse");
