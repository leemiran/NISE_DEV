...
public class totalScoreMemberExcelView extends AbstractExcelView{
	...
	protected void buildExcelDocument(Map model, HSSFWorkbook wb, HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		HSSFSheet sheet = wb.createSheet("totalScoreMember List");
		sheet.setDefaultColumnWidth((short)12);
		
		// put text in first cell
		cell = getCell(sheet, 0, 0);
		setText(cell, "totalScoreMember List");
		
		
		Map<String, Object> map = (Map)model.get("totalScoreMemberMap");
