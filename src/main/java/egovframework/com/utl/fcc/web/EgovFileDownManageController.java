...
import egovframework.com.cmm.service.EgovFileManageUtil;
import egovframework.com.cmm.service.EgovProperties;

@Controller
public class EgovFileDownManageController  {

    /**
     * 파일 다운로드 기능을 제공한다.
     */
    @RequestMapping(value = "/EgovFileDownMng.do")
	...
	request.setAttribute("downFile", stordFilePath + storePath + "/" +filename);
	request.setAttribute("orginFile", original);

	EgovFileManageUtil.downFile(request, response);
