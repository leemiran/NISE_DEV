...
/**
     ...
     * @param StringName : key
     * @return
     */
    public static String[] getStringSequence(Map<String, Object> commandMap, String StringName	){
    	String[] arr = null;
    	if(commandMap.get(StringName) instanceof String[] ){ 
    		arr = (String[])commandMap.get(StringName); 
        }else if(commandMap.get(StringName) instanceof String){ 
        	arr = new String[1];
        	arr[0] = (String)commandMap.get(StringName);
        } 
    	return arr;
    }
