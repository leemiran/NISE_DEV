...
public class BPSubjectData {                                                            
    ...
    private String bookfilenamereal     ;   // 집합과목 첨부파일                        
    private String bookfilenamenew      ;   // 집합과목 첨부파일                        
    ...
    public void setContenttype(String string)   { contenttype= string;              }   
}                                                                                       
