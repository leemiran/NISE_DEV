...
public class BetaSubjectData { 
	 ...
	 * @param i
	 */
	public void setFirstresult(String string) { 
		firstresult = string;
	}
	 ...
	 * @param i
	 */
	public void setFinalresult(String string) { 
		finalresult = string;
	}
}
