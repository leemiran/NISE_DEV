     ...
     public ArrayList selectProjectQuestionsAList(RequestBox box) throws Exception { 
        ...
        try { 
            ...
            if ( ss_action.equals("go") ) { 
                ...
                sql1 += "from 	tz_subj a, tz_cpinfo b where a.producer = b.cpseq ";
				...
				if ( !v_year.equals("") && !v_year.equals("ALL") ) { 
					sql1 += " and substr(a.indate,1,4) = " + StringManager.makeSQL(v_year);
				}
				
				else if ( v_year.equals("") ) { 
					sql1 += " and substr(a.indate,1,4) = " + StringManager.makeSQL(FormatDate.getDate("yyyy") );
				}
