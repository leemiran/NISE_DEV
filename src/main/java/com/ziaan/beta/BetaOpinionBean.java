    ...
    */
    public ArrayList selectListOpinion(RequestBox box) throws Exception { 
        ...
        try { 
            ...
            sql  = " select a.subj subj, a.year year, a.subjseq subjseq, a.lesson lesson, a.lessonseq lessonseq,       ";
            sql += "        a.seq seq, a.userid userid, b.name name, a.answer answer, a.luserid luserid, a.ldate ldate ";
            ...
            sql += "    and a.lessonseq = " + v_lessonseq;
