    ...
    */
    ...
    public int insertQuestion(RequestBox box) throws Exception { 
        ...
        try { 
            ...
            v_examnum = getExamnumSeq(connMgr, v_subj);
    ...
    public int getExamnumSeq(DBConnectionManager connMgr, String p_subj) throws Exception { 
        ...
        return SelectionUtil.getSeq(connMgr, maxdata);
    }
