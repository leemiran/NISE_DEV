// **********************************************************
//  1. 제      목: 과목개설시 맛보기 정보(베타테스트시스템)
//  2. 프로그램명: BetaPreviewData.java
//  3. 개      요:
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
...
public class BetaPreviewData { 
	 ...
	 * @param string
	 */
	public void setMasemail(String string) { 
		masemail = string;
	}
	 ...
	 * @param string
	 */
	public void setRecommender(String string) { 
		recommender = string;
	}
	 ...
	 * @param string
	 */
	public void setSubjtext(String string) { 
		subjtext = string;
	}
