...
//        String s_name      = box.getSession("name");
        ...
        try { 
             ...
             pstmt.setInt   (2 , v_calno            );
             pstmt.setString(3 , v_calday           );
             pstmt.setString(4 , v_caltime          );
             pstmt.setString(5 , v_title            );
             pstmt.setString(6 , v_security_fg      );
             pstmt.setString(7 , v_ftime            );
             pstmt.setString(8 , v_ttime            );
             pstmt.setString(9 , v_day_fg           );
             pstmt.setString(10, v_cal_area         );
             pstmt.setString(11, v_content          );
             pstmt.setString(12, v_cycle_time       );
             pstmt.setString(13, v_cycle_cnt        );
             pstmt.setString(14, v_limit_day_year   );
             pstmt.setString(15, v_loop_fg          );
             pstmt.setString(16, "1"                );
             pstmt.setString(17, s_userid           );
...
//        String v_caltime       = "0000";
        ...
        try { 
             ...
             pstmt = connMgr.prepareStatement(sql);
             pstmt.setString(1 , v_calday           );
             pstmt.setString(2 , v_title            );
             pstmt.setString(3 , v_security_fg      );
             pstmt.setString(4 , v_ftime            );
             pstmt.setString(5 , v_ttime            );
             pstmt.setString(6 , v_day_fg           );
             pstmt.setString(7, v_cal_area         );
             pstmt.setString(8, v_content          );
             pstmt.setString(9, v_cycle_time       );
             pstmt.setString(10, v_cycle_cnt        );
             pstmt.setString(11, v_limit_day_year   );
             pstmt.setString(12, v_loop_fg          );
             pstmt.setString(13, s_userid           );
             pstmt.setString(14, v_cmuno            );
             pstmt.setString(15,v_calno            );
