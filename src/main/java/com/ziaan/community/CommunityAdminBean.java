     ...
     public ArrayList selectPermitList(RequestBox box) throws Exception { 
        ...
        try { 
            ...
            if ( !v_search.equals("") ) {    // 검색어(커뮤니티명)가 있는 경우
                sql += " and sdesc like " + StringManager.makeSQL("%" + v_search + "%") + " ";
            }
            if ( !v_select.equals("") ) {    // 검색항목(카테고리 아이디)이 있는 경우
            sql += " and categoryId like " + StringManager.makeSQL("%" + v_select + "%") + " ";
            }
...
//// //// //// //// ////  폼메일 발송 //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// // 
            ...
            String v_mailTitle = "안녕하세요? e-Academy 운영자입니다.";
//// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// /
    ...
    */
     public ArrayList selectActionLearningList(RequestBox box) throws Exception { 
        ...
        try { 
            ...
            if ( !v_search.equals("") ) {    // 검색어(과목명)가 있는 경우
                sql1 += "and A.subjnm like " + StringManager.makeSQL("%" + v_search + "%") + " ";
            }
...
//        String v_name       = box.getString("p_masterName");
        ...
        try { 
            ...
            sql2 +=  " values (?, ?, ?, ?, dbo.to_date(getdate(),'YYYYMMDD'),'01',  dbo.to_date(getdate(),'YYYYMMDD'),?, ?, ?, ? ,'N',?)";
            pstmt2 = connMgr.prepareStatement(sql2);
            ...
            // sql3 +=  "values(?, ?, ?, ?, dbo.to_date(getdate(),'YYYYMMDD'), '01', dbo.to_date(getdate(),'YYYYMMDD'),'Y')";
            // pstmt3 = connMgr.prepareStatement(sql3);
    ...
    */
     public int insertActionLearningMember(DBConnectionManager connMgr, String v_grcode,int v_commId,String v_subj,String v_year,String v_subjseq, String v_masterId) throws Exception { 
        ...
        try { 
            ...
            sql2 += "values(?, ?, ?, ?, dbo.to_date(getdate(),'YYYYMMDD'), '01',  dbo.to_date(getdate(),'YYYYMMDD'), ?)";
            pstmt2 = connMgr.prepareStatement(sql2);
