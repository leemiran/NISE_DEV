...
//        String sql2 = "";
        ...
        try { 
            ...
            // ----------------------   게시판 번호 가져온다 ----------------------------
            sql = "select isnull(max(seq), 0) from TZ_COMMUNITY_NOTICE where commid = " + v_commid;
...
//        int isOk3 = 1;
        ...
        try { 
            ...
            sql1 = "update TZ_COMMUNITY_NOTICE set title = ?, content=?, userid = ?, name = ?, luserid = ?, ldate = dbo.to_date(getdate(),'YYYYMMDDHH24MISS')";
