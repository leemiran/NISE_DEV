...
{       
	...
	private int resend;				// Table NUMBER    	       
	...
	private String grcodemn;


    public String getGrcodemn() {
		return grcodemn;
	}
	public void setGrcodemn(String grcodemn) {
		this.grcodemn = grcodemn;
	}
    ...
    public void   setRealfile1(String realfile1)  { this.realfile1 = realfile1;     }
    public String getRealfile1()                 { return realfile1;              }  
