...
public class QnaData { 
    ...
    private String sangdamgubun;
    private String sangdamgubunname;
	/**
	 * @return
	 */
    ...
    public void setSangdamgubun(String togubun) {  this.sangdamgubun = sangdamgubun;  }
    public String getSangdamgubun() { return this.sangdamgubun; } 

    public void setSangdamgubunname(String Sangdamgubunname) {  this.sangdamgubunname = sangdamgubunname;  }
    public String getSangdamgubunname() { return this.sangdamgubunname; } 
}
