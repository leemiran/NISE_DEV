...
//          pstmt2.setString(i++,v_lesson);
  ...
  public int deleteQna(RequestBox box) throws Exception { 
    ...
    */
	...
	/**
	 * 질문 답변등록시 해당 권한CM자, 학생에게 자동 SMS발송을 보내기 위한 정보
	 * @param box
	 * @return
	 * @throws Exception
	 */  
    public ArrayList getReceiver(RequestBox box) throws Exception { 
        ...
        try { 
            ...
            box.put("p_title", v_subjnm + "과정의 답변이 등록되었습니다.");
...
//            connMgr.setOracleCLOB(sql, v_content);       //      clob 필드에 스트림을 이용,  data 를 넣는다(Weblogic 인 경우)
