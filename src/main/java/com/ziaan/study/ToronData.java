...
{       	         
    ...
    public void   setAgree(int agree)               { this.agree = agree;           }
    public int    getAgree()                      { return agree;               }
    
    public void   setContrary(int contrary)               { this.contrary = contrary;           }
    public int    getContrary()                      { return contrary;               }
     ...
     * @param string
     */
    public void setDelYn(String string) { 
        delyn = string;
    }
     ...
     * @param string
     */
    public void setAdgadmin(String string) { 
        adgadmin = string;
    }
