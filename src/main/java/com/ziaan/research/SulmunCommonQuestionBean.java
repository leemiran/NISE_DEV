// **********************************************************
// 1. 제      목:
// 2. 프로그램명: SulmunCommonQuestionBean.java
// 3. 개      요:
// 4. 환      경: JDK 1.3
// 5. 버      젼: 0.1
 ...
 */
public class SulmunCommonQuestionBean { 
    ...
    public SulmunCommonQuestionBean() { }
    ...
    */
    public int deleteTZ_sul(DBConnectionManager connMgr, String p_subj, String p_grcode, int p_sulnum, String p_duserid) throws Exception { 
        ...
        try { 
            ...
            // 삭제체크
            sql = " select sulnums  from tz_sulpaper where subj='COMMON' ";
