// **********************************************************
// 1. 제      목:
// 2. 프로그램명: SulmunAllUserBean.java
// 3. 개      요:
// 4. 환      경: JDK 1.3
// 5. 버      젼: 0.1
 ...
 */
public class SulmunAllUserBean { 


    public SulmunAllUserBean() { }
    ...
    */
    public ArrayList SelectUserList(RequestBox box) throws Exception { 
        ...
        String v_subj     = box.getStringDefault("s_subjcourse", SulmunAllBean.DEFAULT_SUBJ);
        String v_grcode = box.getStringDefault("s_grcode", SulmunAllBean.DEFAULT_GRCODE);
