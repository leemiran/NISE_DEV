    ...
    */
    public ArrayList selectQuestionList(DBConnectionManager connMgr, String p_grcode, String p_subj, String p_distcode) throws Exception { 
        ...
        try { 
            ...
            sql += "       tz_code   b, ";
            sql += "       tz_code   c  ";
            sql += "   where lpad(a.distcode, 2, '0') = b.code ";
...
/*    public int insertTZ_sulpaper(DBConnectionManager connMgr, String p_grcode, String p_gyear, String p_subj, String p_subjseq, int p_sulpapernum, String p_sulpapernm, int p_totcnt, 
                                    String p_sulnums, String p_sulmailing, String p_sulstart, String p_sulend, int p_progress, String p_luserid) throws Exception { 
    ...
    public int updateTZ_sulpaper(DBConnectionManager connMgr, String p_grcode, String p_gyear, String p_subj, String p_subjseq, int p_sulpapernum, String p_sulpapernm, int p_totcnt, 
                                                    String p_sulnums, String p_sulmailing, String p_sulstart, String p_sulend, int p_progress, String p_luserid) throws Exception { 
        PreparedStatement   pstmt   = null;
        String              sql     = "";
        int isOk = 0;
    ...
    public int updateTZ_sulpaper(DBConnectionManager connMgr, String p_grcode, String p_subj, int p_sulpapernum, String p_sulpapernm, int p_totcnt, String p_sulnums, String p_sulmailing, String p_sulstart, String p_sulend, int p_progress, String p_luserid) throws Exception { 
        PreparedStatement   pstmt   = null;
        String              sql     = "";
        int isOk = 0;
...
System.out.println("s >>  > " +sql);
    ...
    public ArrayList getSelnums(DBConnectionManager connMgr, String p_subj, String p_grcode, Vector p_sulnums) throws Exception { 
        ...
        try { 
            ...
            while ( st.hasMoreElements() ) { 
	            ...
	            sql += "       a.sultext,  b.selnum, b.seltext, b.selpoint, c.code ";
	            sql += "  from tz_sul     a, ";
	            sql += "       tz_sulsel  b, ";
	            sql += "       tz_code    c, ";
	            sql += "       tz_code    d  ";
	            ...
	            //sql += "   and lpad(a.distcode, 2, '0') = c.code ";		01,02,03이런식으로 나오는 코드 없다. 
    ...
    */
    public ArrayList selectPaperQuestionExampleList(RequestBox box) throws Exception { 
        ...
        try { 
        	...
        	if ( v_sulpapernum == 0 ) { 
            	...
            	boolean v_isSubjSul = getIsSubjSul(connMgr, box);
            	box.put("p_isSubjSul", v_isSubjSul);
    ...
    /**
    @param box          receive from the form object and session
    @return boolean   평가문제 리스트
    */
    public boolean getIsSubjSul(DBConnectionManager	connMgr, RequestBox box) throws Exception { 
        boolean isSubjSul = false;
        ListSet             ls      = null;
        ...
        try { 
            sbSQL.append("\n SELECT DECODE(SUM(CNT),0, 'N', 'Y') AS ISSUBJSUL 					"); // 과정 설문이면 Y, 아니면 N
            sbSQL.append("\n FROM ( 					      									");
            sbSQL.append("\n 	SELECT COUNT(*) AS CNT			      							");
            ...
            ls = connMgr.executeQuery(sbSQL.toString());// System.out.println(sql);
            while ( ls.next() ) { 
...
//                sql += "   and subj    = " + SQLString.Format(v_subj);
    ...
    public ArrayList getExampleData(DBConnectionManager connMgr, String p_subj,  String p_grcode, int p_sulnum) throws Exception { 
        ...
        try { 
            ...
            sql += "   and a.grcode   = b.grcode( +)  ";
			sql += "   and a.sulnum   = b.sulnum( +)  ";
            sql += "   and lpad(a.distcode, 2, '0') = c.code ";
            sql += "   and a.sultype  = d.code ";
            sql += "   and a.subj     = " + SQLString.Format(p_subj);
            sql += "   and a.grcode     = " + SQLString.Format(p_grcode);
    ...
    public static String getSulPaperSelect (String p_grcode, String p_gyear, String p_subj, String name, int selected, String event, String p_subjseq) throws Exception { 
        ...
        try { 
            ...
            sql = " select nvl(sulpapernum,0) sulpapernum,  "
                ...
                + "         where subj='ALL' and grcode='ALL'  and sulpapernum=tz_subjseq.sulpapernum) sulpapernm "
                + " from tz_subjseq  "
                + " where grcode = " + StringManager.makeSQL(p_grcode) + " ";
...
Log.info.println("설문지 >>  >>  >>  >>  > " +sql);
            ...
            if ( ls.next() ) {
                ...
                if ( dbox.getInt("d_sulpapernum") != 0 ) { 
                    ...
                    redamunt += " <option value='0' > 해당과목에 설문지가 없습니다.</option > \n";
                }
            } else {
                redamunt += " <option value='0' > 설문지를 선택하세요.</option > \n";
            }    
    ...
    *  TZ_SULPAPER 이용
     */
     public static String getSulPaperSelect (String p_grcode, String p_gyear, String p_grseq, String p_subj, String name, int selected, String event, String p_subjseq) throws Exception { 
         ...
         try { 
             ...
             //2008.11.17 오충현 사후,사전 설문추가로 쿼리 수정
             sql = " select distinct nvl(b.sulpapernum,0) sulpapernum,  "
                 + "        b.sulpapernm  "
                 + " from tz_subjseq a, tz_sulpaper b "
                 + " where 1 = 1                                 "
             	 + " 	and b.subj = 'ALL' and b.grcode = 'ALL'      "
             	 + " 	and (a.sulpapernum=b.sulpapernum or b.sulpapernum = a.presulpapernum or b.sulpapernum = a.aftersulpapernum )      ";
             
             sql += " and a.grcode = " + StringManager.makeSQL(p_grcode) + " ";
             sql += " and a.year   = " + StringManager.makeSQL(p_gyear)  + " ";
             
             if ( p_subj.equals("ALL") )
                 sql += " and (a.subj, a.subjseq) IN ( SELECT Subj, subjseq FROM Tz_Subjseq WHERE Year = " + SQLString.Format(p_gyear) + " AND grseq = " + SQLString.Format(p_grseq )+ ") \n";
             else    
