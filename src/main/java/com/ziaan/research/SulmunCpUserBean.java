 ...
 */
public class SulmunCpUserBean { 


    public SulmunCpUserBean() { }
    ...
    */   
    public int InsertSulmunUserResult(RequestBox box) throws Exception { 
        ...
        System.out.println("v_cpsulnums ==  ==  == = >>  >>  >>  >>  >>  >>  >>  >>  >>  >>  >>  >>  >>  >>  >> " +v_cpsulnums);
        ...
        try { 
            ...
            pstmt1.setString( 6, v_cpseq);System.out.println(v_cpseq);
            ...
            try { 
                ...
                if ( !rs.next() ) {     //     과거에 등록된 userid 를 확인하고 없을 경우에만 등록          
                   System.out.println("insertinsertinsertinsertinsertinsert");
                   isOk1 = InsertTZ_suleach(connMgr, v_subj , v_grcode, v_gyear,    v_subjseq, v_sulpapernum, v_cpseq, v_sulnums, v_answers, v_luserid, v_cpsulnums);
                   // System.out.println(isOk1);
                   // System.out.println("v_cpsulnums ==  ==  == = >>  >>  >>  >>  >>  >>  >>  >>  >>  >>  >>  >>  >>  >>  >> " +v_cpsulnums);
                } else { 
                   System.out.println("updateupdateupdateupdateupdateupdate");
                   isOk1 = UpdateTZ_suleach(connMgr, v_subj , v_grcode, v_gyear,    v_subjseq, v_sulpapernum, v_cpseq, v_sulnums, v_answers, v_luserid, v_cpsulnums);
                }
    ...
    @return int
    */   
    public int UpdateTZ_suleach(DBConnectionManager connMgr, String p_subj,  String p_grcode,  String p_gyear,    String p_subjseq, int p_sulpapernum,
                            String p_cpseq, String  p_sulnums, String p_answers, String p_luserid, String p_cpsulnums) throws Exception { 
        ...
        try { 
            ...
            pstmt.setString( 1, p_answers);
            pstmt.setString( 2, p_cpsulnums);
            ...
            pstmt.setString( 7, p_subjseq);
            pstmt.setString( 8, p_gyear);
            pstmt.setInt   ( 9, p_sulpapernum);
            pstmt.setString(10, p_cpseq);
            
            // System.out.println("11 == = >> " +p_answers);
            // System.out.println("11 == = >> " +p_cpsulnums);
            // System.out.println("11 == = >> " +p_luserid);
            // System.out.println("11 == = >> " +FormatDate.getDate("yyyyMMddHHmmss") );
			// System.out.println("11 == = >> " +p_subj);
            // System.out.println("11 == = >> " +p_grcode);
            // System.out.println("11 == = >> " +p_subjseq);
            // System.out.println("11 == = >> " +p_gyear);
            // System.out.println("11 == = >> " +p_sulpapernum);
            // System.out.println("11 == = >> " +p_cpseq);
    ...
    */  
    public int InsertTZ_suleach(DBConnectionManager connMgr, String p_subj,  String p_grcode,  String p_gyear,    String p_subjseq, int p_sulpapernum,
        ...
        try { 
            ...
            pstmt.setString(11, p_cpsulnums);
     ...
     public ArrayList selectGraduationSubjectList(RequestBox box) throws Exception { 
      ...
      ErrorManager.systemOutPrintln(box); 
        try { 
            ...
            sql1 += "where A.subj=B.subj and A.year=B.year and A.subjseq=B.subjseq and B.userid=" +SQLString.Format(v_user_id);
            sql1 += " and to_char(sysdate, 'YYYYMMDDHH') between A.eduend and trim(A.eduend +1000000) ";
            sql1 += " order by A.course,A.cyear,A.courseseq,A.subj,A.year,A.subjseq,A.edustart,A.eduend ";
