// **********************************************************
// 1. 제      목:
// 2. 프로그램명: SulmunCpQuestionBean.java
// 3. 개      요:
// 4. 환      경: JDK 1.3
// 5. 버      젼: 0.1
        ...
        try { 
            ...
            while ( em.hasMoreElements() ) { 
                ...
                if ( !v_seltext.trim().equals("") ) { 
                    ...
                    System.out.println(v_sulnum);
                    System.out.println(v_selnum);
                    System.out.println(v_seltext);
                    System.out.println(Integer.parseInt(v_selpoint));
