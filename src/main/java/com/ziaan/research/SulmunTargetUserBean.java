 ...
 */
public class SulmunTargetUserBean { 


    public SulmunTargetUserBean() { }
        ...
        try { 
            ...
            list = new ArrayList();
              ...
              sql1 = "SELECT a.grcode, b.year, a.sulpapernum,  a.sulpapernm , a.sulstart, a.sulend, a.totcnt  ,  "
                   + " (select count(*) from tz_suleach where userid='" +v_user_id + "' and subj='TARGET' AND GRCODE=a.grcode and sulpapernum=a.sulpapernum) sulresult , "
                   + " (case when a.sulend >= to_char(sysdate,'YYYYMMDD') then 'Y' else 'N' end ) issul  "
                   + "FROM TZ_SULPAPER a, TZ_SULMEMBER b "
                   + "WHERE a.sulpapernum=b.sulpapernum and a.subj='TARGET' and b.USERID='" +v_user_id + "' ";
