...
public class SulmunCommonPaperBean { 
    ...
    */
    ...
    @return int
    */
    public int insertTZ_sulpaper(DBConnectionManager connMgr, String p_grcode, String p_subj, int p_sulpapernum, String p_sulpapernm, int p_totcnt, String p_sulnums, String p_sulmailing, String p_sulstart, String p_sulend, String p_luserid, String v_sulgubun) throws Exception { 
        ...
        try { 
            ...
            sql +=  " sulstart, sulend,  luserid,  ldate, sulgubun )   ";
            sql +=  " values ";
            sql +=  "(?,         ?,       ?,         ?,   ";
            sql +=  " ?,         ?,            ";
            sql +=  " ?,         ?,       ?, ";
    ...
    @return int
    */
    public int updateTZ_sulpaper(DBConnectionManager connMgr, String p_grcode, String p_subj, int p_sulpapernum, String p_sulpapernm, int p_totcnt, String p_sulnums, String p_sulmailing, String p_sulstart, String p_sulend, String p_luserid, String p_sulgubun) throws Exception { 
        PreparedStatement   pstmt   = null;
        String              sql     = "";
        int isOk = 0;
        ...
        try { 
            ...
            pstmt.setString(10, p_sulgubun);
            pstmt.setString(11, p_grcode);
            pstmt.setString(12, p_subj);
            pstmt.setInt   (13, p_sulpapernum);
    ...
    */
    public int insertPaper(RequestBox box) throws Exception { 
        ...
        try { 
            ...
            isOk = insertTZ_sulpaper(connMgr,  v_grcode, v_subj, v_sulpapernum, v_sulpapernm, v_totcnt, v_sulnums, v_sulmailing, v_sulstart, v_sulend, v_luserid, v_sulgubun);
    ...
    */
    public int updatePaper(RequestBox box) throws Exception { 
        ...
        try { 
            ...
            isOk = updateTZ_sulpaper(connMgr,  v_grcode, v_subj, v_sulpapernum, v_sulpapernm, v_totcnt, v_sulnums, v_sulmailing, v_sulstart, v_sulend, v_luserid,v_sulgubun);
