// **********************************************************
// 1. 제      목:
// 2. 프로그램명: ExamMasterInfoBean.java
// 3. 개      요:
// 4. 환      경: JDK 1.3
// 5. 버      젼: 0.1
 ...
 */
public class ExamMasterInfoBean { 

    public ExamMasterInfoBean() { }
    ...
    @return ArrayList
    */
    public ArrayList selectExamMasterInfoList(RequestBox box) throws Exception { 
    ...
    */
    public ArrayList getExamMasterList(DBConnectionManager connMgr, String p_upperclass, String p_middleclass, String p_lowerclass,String p_subjcourse) throws Exception { 
        ...
        try { 
            ...
            sql += "      ,(select count(subj) from tz_exammaster where subj = a.subj) rowspan_cnt ";            
    ...
    */
    public int insertExamMaster(RequestBox box) throws Exception { 
        ...
        try { 
            ...
            dbox = getExamMasterData(connMgr, v_subj, v_lesson, v_examtype);
            if ( dbox == null ) { 
               isOk = insertTZ_exammaster(connMgr, v_subj, v_lesson, v_examtype, v_lessonstart, v_lessonend, v_examtime, v_exampoint, v_examcnt, v_totalscore, v_cntlevel1, v_cntlevel2, v_cntlevel3, v_level1text, v_level2text, v_level3text, v_isopenanswer, v_isopenexp, v_retrycnt, v_progress, v_luserid);
           } else { 
              isOk = 0;
           }
        } catch ( Exception ex ) { 
        ...
        try { 
            ...
            rs = pstmt.executeQuery();
		    		if ( rs.next() ) { 
						...
						if ( isOk == 0) { 
            	isOk = updateTZ_exammaster(connMgr, v_subj, v_lesson, v_examtype, v_lessonstart, v_lessonend, v_examtime, v_exampoint, v_examcnt, v_totalscore, v_cntlevel1, v_cntlevel2, v_cntlevel3, v_level1text, v_level2text, v_level3text,  v_isopenanswer, v_isopenexp, v_retrycnt, v_progress, v_luserid);
            }
        } catch ( Exception ex ) { 
            isOk = 0;
            connMgr.rollback();
