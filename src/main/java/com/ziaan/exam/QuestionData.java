...
public class QuestionData { 
    ...
    private int     examnum     ;   // 문제번호
    private String  lesson      ;   // 해당일차,  online test : OT
    private String  examtype    ;   // exam type : S(single), M(multi), D(short descript)
    private String  text        ;   // exam text
