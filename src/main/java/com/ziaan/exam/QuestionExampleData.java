...
public class QuestionExampleData { 
	 ...
	 * @param string
	 */
	public void setExamtypenm(String string) { 
		Question.setExamtypenm(string);
	}
	...
	public void add(ExampleData exampledata) { 
	...
	public int getSelnum(int selnum) { 
		int i = 0;
		ExampleData exampledata = get(selnum);
		if ( exampledata != null ) { 
	...
	public String getIsanswer(int selnum) { 
		...
		ExampleData exampledata = get(selnum);
		if ( exampledata != null ) { 
			string  = exampledata.getIsanswer();
		}
		return string;
	}
