...
public class ExamMasterBean { 
    ...
    */
    public DataBox getExamMasterData(DBConnectionManager connMgr, String p_subj, String p_lesson, String p_examtype) throws Exception { 
        ...
        try { 
            ...
            sql += "       a.isopenanswer,  a.isopenexp, a.retrycnt, GET_CODENM(" + SQLString.Format(ExamBean.PTYPE) + ", nvl(a.examtype, '')) examtypenm, a.startdt, a.enddt ";
            sql += "  from tz_exammaster a ";
    ...
    */
    public int insertExamMaster(RequestBox box) throws Exception { 
        ...
        try { 
            ...
            dbox = getExamMasterData(connMgr, v_subj, v_lesson, v_examtype);
            if ( dbox == null ) { 
               isOk = insertTZ_exammaster(connMgr, v_subj, v_lesson, v_examtype, v_lessonstart, v_lessonend, v_examtime, v_exampoint, v_examcnt, v_totalscore, v_cntlevel1, v_cntlevel2, v_cntlevel3, v_level1text, v_level2text, v_level3text, v_isopenanswer, v_isopenexp, v_retrycnt, v_progress, v_luserid, v_startdt, v_enddt);
           } else { 
              isOk = 0;
           }
        } catch ( Exception ex ) { 
    ...
    @return int  
    */
    public int insertTZ_exammaster(DBConnectionManager connMgr, String p_subj, String p_lesson, String p_examtype, String p_lessonstart, String p_lessonend, 
        ...
        try { 
            ...
            pstmt.setString( 4, p_lessonstart);
            pstmt.setString( 5, p_lessonend);
            
            pstmt.setString( 6, p_examtime);
			pstmt.setInt   ( 7, p_exampoint);
            pstmt.setInt   ( 8, p_examcnt);
            pstmt.setInt   (9, p_totalscore);
            pstmt.setInt(10, p_cntlevel1);
            
            pstmt.setInt(11, p_cntlevel2);
            pstmt.setInt(12, p_cntlevel3);
            pstmt.setString(13, p_level1text);
            pstmt.setString(14, p_level2text);
            pstmt.setString(15, p_level3text);
            
            pstmt.setString(16, p_isopenanswer);
            pstmt.setString(17, p_isopenexp);
            pstmt.setInt   (18, p_retrycnt);
            pstmt.setInt   (19, p_progress);
            pstmt.setString(20, p_luserid);
            
            pstmt.setString(21, FormatDate.getDate("yyyyMMddHHmmss") );
            pstmt.setString(22, p_startdt);
            pstmt.setString(23, p_enddt);
    ...
    */
    public int updateExamMaster(RequestBox box) throws Exception { 
        ...
        String  v_luserid   = box.getSession("userid");
        String  v_startdt   = box.getString("p_startdt").replaceAll("-", "");
        String  v_enddt   	= box.getString("p_enddt").replaceAll("-", "");
        ...
        try { 
			...
			if ( isOk == 0) { 
			    isOk = updateTZ_exammaster(connMgr, v_subj, v_lesson, v_examtype, v_lessonstart, v_lessonend, v_examtime, v_exampoint, v_examcnt, v_totalscore, v_cntlevel1, v_cntlevel2, v_cntlevel3, v_level1text, v_level2text, v_level3text,  v_isopenanswer, v_isopenexp, v_retrycnt, v_progress, v_luserid, v_startdt, v_enddt);
            }
        } catch ( Exception ex ) { 
            isOk = 0;
            connMgr.rollback();
    ...
    @return int
    */
    public int updateTZ_exammaster(DBConnectionManager connMgr, String p_subj, String p_lesson, String p_examtype, String p_lessonstart, String p_lessonend, 
		                    String p_examtime,    int    p_exampoint,     int p_examcnt,             int p_totalscore, 
                            int    p_cntlevel1,  int    p_cntlevel2,  int    p_cntlevel3,  String p_level1text,  String p_level2text,  String p_level3text,  String p_isopenanswer,
                            String    p_isopenexp,  int     p_retrycnt,        int p_progress,        String p_luserid, String p_startdt, String p_enddt) throws Exception { 
        ...
        try { 
            ...
            pstmt.setInt( 7, p_cntlevel1);
            pstmt.setInt   ( 8, p_cntlevel2);
            pstmt.setInt   ( 9, p_cntlevel3);
            pstmt.setString( 10, p_level1text);
            pstmt.setString   ( 11, p_level2text);
            pstmt.setString   ( 12, p_level3text);
            pstmt.setString(13, p_isopenanswer);
            pstmt.setString(14, p_isopenexp);
            pstmt.setInt    (15, p_retrycnt);
            pstmt.setInt    (16, p_progress);
            pstmt.setString(17, p_luserid);
            pstmt.setString(18, FormatDate.getDate("yyyyMMddHHmmss") );
            pstmt.setString(19, p_startdt);
            pstmt.setString(20, p_enddt);
