...
{ 
    ...
    public void   setCreduman(String ziaanman)   { this.ziaanman = ziaanman;      }
    public String getCreduman()                  { return ziaanman;               }
