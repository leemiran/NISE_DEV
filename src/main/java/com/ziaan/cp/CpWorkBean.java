    ...
    */
    public ArrayList selectPdsList(RequestBox box,String v_type) throws Exception { 
        ...
        try { 
            ...
            sql =  " select a.seq, a.userid, a.name, a.title, a.indate, a.cnt,a.okyn1,a.okuserid1,a.okdate1,a.okyn2,a.okuserid2,a.okdate2,";
            sql += "(select count(realfile) from TZ_BOARDfile where tabseq = a.tabseq and seq = a.seq)filecnt, ";
            sql += " c.cpnm ";
            sql += " from TZ_BOARD a, tz_cpinfo c ";
