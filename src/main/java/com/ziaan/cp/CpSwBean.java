...
System.out.println("외주 s/w 리스트::::" +sql);
    ...
    */
    public ArrayList selectPdsListNum(RequestBox box) throws Exception { 
        ...
        try { 
			...
			sql  = " select seq, name, title, indate, cnt from                      ";
            sql += "( select rownum, seq, userid, name, title, indate, cnt ";
            sql += "from tz_board a" ;
...
System.out.println("cpsw 게시판 상세보기::::" +sql);
			ls = connMgr.executeQuery(sql); 
