    ...
    */
    public ArrayList selectResultList(RequestBox box) throws Exception { 
        ...
        try { 
			...
			sql = "select a.subj, a.subjnm, b.year, b.subjseq, b.subjseqgr, b.propstart, b.propend, b.edustart, b.eduend, c.cpnm, b.cpsubjseq, count(d.userid) as usercnt, ";
			sql += " b.isclosed, b.iscpresult, b.cpresultrealfile, b.cpresultnewfile, b.cpresultldate, nvl(iscpflag,'N') as iscpflag ";
			sql += " from ";
			sql += "   tz_subj a, ";
			sql += "   tz_subjseq b, ";
			sql += "   tz_cpinfo c, ";
			...
			if ( !v_grcode.equals("") ) { 
				...
				if ( !v_grseq.equals("ALL") ) { 
				  sql += " b.grseq = " + SQLString.Format(v_grseq);
				  sql += " and ";
				}
				...
				if ( !v_searchtext.equals("") ) { 	//    검색어가 있으면
	                ...
	                sql += " lower(a.subjnm) like " + SQLString.Format("%" + v_searchtext.toLowerCase() + "%");
	                if ( !v_gyear.equals("") ) { 
	                	sql += " and ";
	                }
	            }
            ...
            sql += " group by a.subj, a.subjnm, b.year, b.subjseq, b.subjseqgr, b.propstart, b.propend, b.edustart, b.eduend, b.cpsubjseq, ";
            sql += " c.cpnm, b.isclosed, b.iscpresult, b.cpresultrealfile, b.cpresultnewfile, b.cpresultldate, b.iscpflag ";
...
System.out.println("sql_subjcode=" +sql);
    ...
    public int insertCPexcelTemp(Hashtable data) throws Exception { 
		...
		double v_report		 = ((Double)data.get("report")).doubleValue(); // 과제 점수
        ...
        try { 
            ...
            System.out.println("maxseq ==  ==  ==  ==  ==  == = >>  >>  >>  >>  >>  >>  >>  >>  >>  >>  >>  >>  >>  >>  >>  >>  >> " +maxseq);
                ...
                // System.out.println(v_inputtime);                                                20051201155844
                // System.out.println(v_subj);                                                     1028          
                // System.out.println(v_year);                                                     2005          
                // System.out.println(v_subjseq);                                                  0005          
                // System.out.println(v_userid);                                                   k9201083      
                // System.out.println(v_score);                                                    8.8           
                // System.out.println(v_tstep);                                                    10.0          
                // System.out.println(v_mtest);                                                    0.0           
                // System.out.println(v_ftest);                                                    7.0           
                // System.out.println(v_report);                                                   0.0           
                // System.out.println(v_act);                                                      0.0           
                // System.out.println(v_etc1);                                                     0.0           
                // System.out.println(v_etc2);                                                     0.0           
                ...
                // System.out.println(0);                                                          0             
                // System.out.println(0);                                                          0             
                // System.out.println(v_isgraduated);                                              N             
                // System.out.println(v_luserid);                                                  lee1          
                // System.out.println(FormatDate.getDate("yyyyMMddHHmmss") );                       20051201155845
                // System.out.println(maxseq);                                                     00005         
                // System.out.println(v_subjseqgr);                                                0001          
                // System.out.println(v_rank);                                             
                // System.out.println(v_sangdamtxt);                                               null          
