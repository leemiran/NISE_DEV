// **********************************************************
//  1. 제      목: 컨텐츠 유지보수 업체관리
//  2. 프로그램명: CpAsCompBean.java
//  3. 개      요: 컨텐츠 유지보수 업체관리 프로그램
//  4. 환      경: JDK 1.5
//  5. 버      젼: 1.0
//  6. 작      성: 김미향 2009. 01. 28
//  7. 수      정:
// **********************************************************
...
public class CpAsCompBean { 
	...
	public DataBox selectComp(RequestBox box) throws Exception { 
        ...
        try { 
			...
			sql = "select                                                                       \n";
			sql += "   a.cpseq,           a.cpnm,            a.cpbirth_date,        a.homesite,      \n";
            ...
            sql += "   a.bigo,            a.birth_date                                               \n";
			sql += " from ";
			sql += " tz_cpasinfo a, tz_outmember b ";
			sql += "   where ";
			sql += "   a.userid = b.userid and a.cpseq = " + SQLString.Format(v_seq);
            
            ls = connMgr.executeQuery(sql);

        	// 관리자가 컨텐츠 유지보수 업체계정으로 접속했을경우의 처리
    ...
    /**
    새로운 컨텐츠 유지보수 업체 정보 등록
    @param box		receive from the form object and session
    @return int		컨텐츠 유지보수 업체 등록 정상처리여부(1:update success,0:update fail)
    */
     public int insertComp(RequestBox box) throws Exception { 
        ...
        int isOk4 = 1;
        int isOk5 = 1;
        DataBox dbox        = this.selectMemberInfo(box.getString("p_userid"));
        String v_cpbirth_date    = box.getString("p_cpbirth_date1") + "-" + box.getString("p_cpbirth_date2") + "-" + box.getString("p_cpbirth_date3");
        ...
        String v_birth_date      = dbox.getString("d_birth_date");
        String v_email      = box.getString("p_email");
        String v_comtel     = box.getStringDefault("p_comtel", dbox.getString("d_comptel"));
        ...
        try { 
            ...
            // ----------------------   컨텐츠 유지보수 업체 seq번호를 가져온다 ----------------------------
            sql = "select nvl(max(cpseq), '0000') from tz_cpasinfo";
            ls = connMgr.executeQuery(sql);
            ls.next();
            String v_seq = CodeConfigBean.addZero(StringManager.toInt( ls.getString(1)) + 1, 4);
            ls.close();
            // ------------------------------------------------------------------------------------

            //// //// //// //// //// //// //// //// //   컨텐츠 유지보수 업체정보 table 에 입력  //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// ///
            sql1 =  " insert into tz_cpasinfo(cpseq, userid, cpbirth_date, cpnm, homesite, address, luserid, ldate, compgubun, handphone, \n";
            ...
            pstmt1.setString(3,  v_cpbirth_date);
            ...
            pstmt1.setString(39, v_birth_date);
            ...
            //// //// //// //// //// //// //// //// //   member table 에 회원정보 입력  //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// ///
            sql2 =  "insert into tz_outmember(userid, pwd, name, email, comptel, handphone, birth_date)";
            sql2 += " values (?, ?, ?, ?, ?, ?, ?) ";
            ...
            pstmt2.setString(7, v_birth_date     );

            isOk2 = pstmt2.executeUpdate();
            
            //// //// //// //// //// //// //// //// //   tz_manager table 에 회원정보 입력  //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// ///
            sql3 =  " delete from tz_manager WHERE userid = ? AND gadmin = ? ";
            ...
            sql4 =  "delete from TZ_OUTCOMPMAN where userid = ? and comp = ?";

            pstmt4 = connMgr.prepareStatement(sql4);
            pstmt4.setString(1, v_userid);
            pstmt4.setString(2, v_seq);
    ...
    선택된 회사정보 수정
    @param box		receive from the form object and session
    @return int		컨텐츠 유지보수 업체 수정 정상처리여부(1:update success,0:update fail)
    */
     public int updateComp(RequestBox box) throws Exception { 
        ...
        String v_address = box.getString("p_address");
        String v_userid = box.getString("p_userid");
        String v_userid1 = box.getString("p_userid1");
        String v_pwd        = dbox.getString("d_pwd");
        String v_name = box.getString("p_name");
        String v_birth_date      = dbox.getString("d_birth_date");
        String v_email = box.getString("p_email");
        String v_comtel = box.getStringDefault("p_comtel","d_comptel");
        String v_handphone = box.getString("p_handphone");
        ...
        try { 
            ...
            //// //// //// //// //// //// //// //// //   컨텐츠 유지보수 업체정보 table 수정  //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// ///
            sql1 =  "update tz_cpasinfo set ";
            sql1 += "  cpbirth_date        = ?, "; 
            sql1 += "  cpnm           = ?, ";
            sql1 += "  homesite       = ?, ";
            sql1 += "  address        = ?, ";
            ...
            pstmt1.setString(1, v_cpbirth_date);
            ...
            pstmt1.setString(37, v_birth_date);
            pstmt1.setString(38, v_userid);
            pstmt1.setString(39, v_seq);
            
            isOk1 = pstmt1.executeUpdate();
            
            if ( v_userid.equals(v_userid1) ) {
                //// //// //// //// //// //// //// //// //   OUTmember table 회원정보 수정  //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// ///
                sql2 =  "update tz_outmember set name =?, email =?, comptel =?, handphone=?, birth_date=?";
                sql2 += " where userid = ? ";
                
                pstmt2 = connMgr.prepareStatement(sql2);
                
                pstmt2.setString(1, v_name);
                pstmt2.setString(2, v_email);
                pstmt2.setString(3, v_comtel);
                pstmt2.setString(4, v_handphone);
                pstmt2.setString(5, v_birth_date);
    ...
    선택된 회사정보 삭제
    @param box		receive from the form object and session
    @return int		컨텐츠 유지보수 업체 삭제 정상처리여부(1:update success,0:update fail)
    */
    public int deleteComp(RequestBox box) throws Exception { 
        ...
        try { 
            ...
            sql1 = "delete from tz_cpasinfo where cpseq = ?";
    ...
    */
    public DataBox userCheck(RequestBox box) throws Exception { 
        ...
        try { 
            ...
            sql = "select count(userid) as cnt from tz_member where lower(userid) = lower(" + SQLString.Format(v_userid) + ")";
    ...
    @return DataBox 카운트
    */
    public DataBox selectMemberInfo(String v_userid) throws Exception { 
        DBConnectionManager connMgr = null;
        ...
        try { 
            ...
            sql = "select fn_crypt('2', a.birth_date, 'knise') birth_date, fn_crypt('2', a.pwd, 'knise') pwd, b.telno as comptel from tz_member a, tz_compclass b where a.comp = b.comp(+) and a.userid = " + SQLString.Format(v_userid) + "";
    ...
    /**
    컨텐츠 유지보수 업체회사코드 조회
    @param	p_userid	컨텐츠 유지보수 업체담당자 아이디
    @return	String		컨텐츠 유지보수 업체코드
    */
   public String selectCPseq(String p_userid) throws Exception { 
        ...
        try { 
			...
			sql = " select cpseq, cpnm "
				+ " from   tz_cpasinfo "
				+ " where  userid = " + SQLString.Format(p_userid);
