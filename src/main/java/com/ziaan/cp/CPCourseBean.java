// **********************************************************
//  1. 제      목: 과목관리 빈
//  2. 프로그램명: CPCourseBean.java
//  3. 개      요: 과목관리관리 프로그램
//  4. 환      경: JDK 1.4
//  5. 버      젼: 1.0
//  6. 작      성: 오충현 2008. 10. 10
//  7. 수      정:
// **********************************************************
    ...
    */
    public ArrayList selectCourseList(RequestBox box) throws Exception { 
        ...
        try { 
			...
			sql += "   a.preurl,                 \n";
			sql += "   a.conturl,                \n";
			sql += "   nvl(a.cpsubj,'') cpsubj,  \n";
			sql += "   b.cpnm,                   \n";
			sql += "   a.cpapproval              \n";
			sql += " from tz_subj a, tz_cpinfo b \n";
			sql += " where  1=1 \n";
			sql += "  and isoutsourcing = 'Y' \n";

			// 과목명검색
			if ( !v_searchtext.equals("") ) { 	//    검색어가 있으면
                
                // v_pageno = 1;	//      검색할 경우 첫번째 페이지가 로딩된다
                sql += " and upper(a.subjnm) like upper(" + StringManager.makeSQL("%" + v_searchtext + "%") + ")";
            ...
            if ( !v_cp.equals("") && !v_cp.equals("ALL") ) { 
                sql += " and a.owner = " + StringManager.makeSQL(v_cp);
            ...
            System.out.println("cpsubj_sql ==  == >>  > " +sql);
    ...
    public DataBox SelectSubjectData(RequestBox box) throws Exception {
        ...
        try { 
            ...
            sbSQL.append(" SELECT  (                                                                                                \n")
                 ...
                 .append("             ), NVL((                                                                                     \n")
                 .append("                 SELECT  comp as companynm                                                                        \n")
                 ...
                 .append("     --,   a.rndcreditadd      , a.rndcreditdeduct     \r\n , a.isablereview    , a.isoutsourcing                \n")
                 .append("     ,   a.conturl           , a.isapproval          --, a.rndjijung     \r\n  , bookfilenamereal               \n")
                 ...
                 .append("     ,   tz_member    b                                                                                   \n")
                 .append("     ,   tz_member    c                                                                                   \n")
                 .append("     ,   tz_compclass      d                                                                                   \n")
                 .append("     ,   tz_compclass      e                                                                                   \n")
            ...
            System.out.println(this.getClass().getName() + "." + "SelectSubjectData() Printing Order " + ++iSysAdd + ". ======[SQL] : " + " [\n" + sbSQL.toString() + "\n]");
...
/*            
            ...
            sql +=  "        a.muserid,    a.cuserid,        a.isuse,          a.ispropose,                ";
