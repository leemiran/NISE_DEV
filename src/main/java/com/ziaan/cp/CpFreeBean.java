...
public class CpFreeBean { 
    private ConfigSet config;
    private int row;
	private String v_type = "AG";
    ...
    */
    public ArrayList selectPdsList(RequestBox box) throws Exception { 
        ...
        try { 
            ...
            sql = "select a.seq, a.userid, a.name, a.title, a.indate, a.cnt";
            sql += " from tz_board a, tz_boardfile b";
            sql += " where a.seq = b.seq( +) and a.tabseq = " + v_tabseq;
    ...
    */
     public int insertPds(RequestBox box) throws Exception { 
        ...
        try { 
           ...
           //// //// //// //// //// //// //// //// //   게시판 table 에 입력  //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// ///
            sql1 =  "insert into TZ_BOARD(TABSEQ,SEQ,TITLE,USERID,NAME,CONTENT,INDATE)";
     ...
     public int updatePds(RequestBox box) throws Exception { 
        ...
        try { 
            ...
            if ( !v_newMotionName.equals("") ) {     //      수정할 첨부파일이 있다면..
                ...
                sql1 = "update tz_board set title = ?, userid = ?, name = ?, luserid = ?, content = ?, indate = to_char(sysdate, 'YYYYMMDDHH24MISS'),ldate = to_char(sysdate, 'YYYYMMDDHH24MISS')";
