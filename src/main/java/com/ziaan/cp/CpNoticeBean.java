...
System.out.println("s_cpseq::::" +s_cpseq);
        ...
        try { 
            ...
            sql += ", '20'||replace(to_char(to_date(substr(addate, 0, 8)) +7), '/', '') newdate ";
    ...
    */
    ...
    public ArrayList selectNoticeListNum(RequestBox box) throws Exception { 
        ...
        try { 
            ...
            list = new ArrayList();
			sql =  " select seq, addate, adtitle, adname,  cnt, addate,   '20'||replace(to_char(to_date(substr(addate, 0, 8)) +7), '/', '') newdate from                      ";
            sql += "  (select rownum, seq, adname, adtitle, addate, cnt";
            sql += "   from tz_Notice ";
