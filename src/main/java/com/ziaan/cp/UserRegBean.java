    ...
    */
    public ArrayList selectCompList(RequestBox box) throws Exception { 
        ...
        try { 
			...
			sql = "select a.cpseq, a.cpnm, a.cpbirth_date, a.homesite, a.address, a.ldate, b.userid, b.name, b.email, b.comptel ";
    ...
    */
	public DataBox selectComp(RequestBox box) throws Exception { 
        ...
        try { 
			...
			sql = "select a.cpseq, a.cpnm, a.cpbirth_date, a.homesite, a.address, a.ldate, b.userid, fn_crypt('2', b.pwd, 'knise') pwd, b.name, b.email, b.comptel ";
			sql += " from tz_cpinfo a, tz_member b ";
    ...
    */
     public int insertComp(RequestBox box) throws Exception { 
        ...
        try { 
            ...
            //// //// //// //// //// //// //// //// //   외주업체정보 table 에 입력  //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// ///
            sql1 =  "insert into tz_cpinfo(cpseq, userid, cpbirth_date, cpnm, homesite, address, luserid, ldate)";
            ...
            sql2 += " values (?, fn_crypt('1', ?, 'knise'), ?, ?, ?, 'O') ";
            ...
            if ( pstmt3 != null ) { try { pstmt2.close(); } catch ( Exception e ) { } }
    ...
    */
     public int updateComp(RequestBox box) throws Exception { 
        ...
        try { 
            ...
            //// //// //// //// //// //// //// //// //   외주업체정보 table 수정  //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// ///
            sql1 =  "update tz_cpinfo set cpbirth_date = ?, cpnm = ?, homesite = ?, address = ?, luserid = ?, ldate = to_char(sysdate, 'YYYYMMDDHH24MISS')";
            sql1 += "  where cpseq = ? ";
            ...
            sql2 =  "update tz_member set pwd =fn_crypt('1', ?, 'knise'), name =?, email =?, comptel =?";
            sql2 += " where userid = ? ";
    ...
    */
    public DataBox userCheck(RequestBox box) throws Exception { 
        ...
        try { 
            ...
            sql += " and substr(fn_crypt('2', birth_date, 'knise'),1,6) = " + SQLString.Format(v_birth_date);
