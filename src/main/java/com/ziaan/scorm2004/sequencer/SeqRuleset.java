...
public class SeqRuleset implements Serializable
{
    ...
    */
   /* package */
   final static int RULE_TYPE_ANY               =  1;
    ...
    */
   /* package */
   final static int RULE_TYPE_EXIT              =  2;
    ...
    */
   /* package */
   final static int RULE_TYPE_POST              =  3;
    ...
    */
   /* package */
   final static int RULE_TYPE_SKIPPED           =  4;
    ...
    */
   /* package */
   final static int RULE_TYPE_DISABLED          =  5;
    ...
    */
   /* package */
   final static int RULE_TYPE_HIDDEN            =  6;
    ...
    */
   /* package */
   final static int RULE_TYPE_FORWARDBLOCK      =  7;
    ...
    * 
    * @param ioThisActivity The target activity of the rule evaluation.
    * 
    ...
    * @see <code>SeqRuleset.RULE_TYPE_[XXX]</code>.
    */
