...

{
    ...
    */
   public final static int ROLLUP_ACTION_NOCHANGE       = 0;
    ...
    * <br>[SEQUENCING SUBSYSTEM CONSTANT]
    */
   public final static int ROLLUP_ACTION_SATISFIED      = 1;
    ...
    * <br>[SEQUENCING SUBSYSTEM CONSTANT]
    */
   public final static int ROLLUP_ACTION_NOTSATISFIED   = 2;
    ...
    * <br>[SEQUENCING SUBSYSTEM CONSTANT]
    */
   public final static int ROLLUP_ACTION_COMPLETED      = 3;
    ...
    * <br>[SEQUENCING SUBSYSTEM CONSTANT]
    */
   public final static int ROLLUP_ACTION_INCOMPLETE     = 4;
   ...
   private boolean evaluateAll(Vector iChildren)
   {
      ...
      while ( result && i < iChildren.size() )
      {
         ...
         {
            result = result && 
               (mConditions.evaluate(tempActivity) ==
   ...
   private boolean evaluateMinCount(Vector iChildren)
   {
      ...
      while ( (count < mMinCount) && i < iChildren.size() )
      {
         ...
         if ( isIncluded(tempActivity) )
         {
            if ( mConditions.evaluate(tempActivity) ==
                 SeqConditionSet.EVALUATE_TRUE )
            {
               count++;
            }
