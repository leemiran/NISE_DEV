...
public class LaunchData
{
   ...
   private ArrayList mResFileUrl;

   private ArrayList mRefResId;
   
   private String mItemMetaLocation;
   
   private String mResourceMetaLocation;
...
private int mTreeOrder;
   ...
   public LaunchData()
   {
      mLogger = Logger.getLogger("com.ziaan.scorm2004.validator");
      ...
      mResType                      = new String();;
      mResFileUrl                   = new ArrayList();
      mRefResId                     = new ArrayList();
   ...
   public void print()
   {
      ...
      mLogger.fine( "####   isvisible = '" + mIsVisible + "'");
   ...
   // Added code by Jin-pil Chung, 2006.04.28
   ...
   public void setResType( String iResType )
   {
       mResType = iResType;
   }
   ...
   public void setResFileUrl(ArrayList iResFileUrl)
   {
       mResFileUrl = iResFileUrl;
   }

   public ArrayList getResFileUrl()
   {
       return mResFileUrl;
   }

   public void setRefResId(ArrayList iRefResId)
   {
       mRefResId = iRefResId;
   }

   public ArrayList getRefResId()
   {
       return mRefResId;
   }

   public void setItemMetaLocation(String iItemMetaLocation)
   {
       mItemMetaLocation = iItemMetaLocation;
   }
   
   public String getItemMetaLocation()
   {
       return mItemMetaLocation;
   }
   
   public void setResourceMetaLocation(String iResourceMetaLocation)
   {
       mResourceMetaLocation = iResourceMetaLocation;
   }
   
   public String getResourceMetaLocation()
   {
       return mResourceMetaLocation;
   }
   
   public void setObjID(String iObjID)
   {
       mObjID = iObjID;
   }
   ...
   public void setItemPIdentifier(String iParentIdentifier)
   {
       mParentIdentifier = iParentIdentifier;
   }

   public String getItemPIdentifier()
   {
       return mParentIdentifier;
   }

   public void setTreeOrder(int iTreeOrder)
   {
       mTreeOrder = iTreeOrder;
   }
