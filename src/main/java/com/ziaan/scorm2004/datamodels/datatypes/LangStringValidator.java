...
{
   /**
    * Describes the et of all 2 and 3 character country codes and their 
   ...
   public boolean compare(String iFirst, String iSecond, Vector iDelimiters)
   {
      ...
      if ( iFirst != null && iSecond != null )
      {
         ...
         if ( !done )
         {
            ...
            country1 = iFirst.substring(curDash1);
            country2 = iSecond.substring(curDash2);
                 ...
                 country2.trim().length() > 0 )
            {
               ...
               else if ( country2.length() == 3 )
               {
                  ...
                  try
                  {
                     int test = Integer.parseInt(country2, 10);
         ...
         if ( !done )
         {
            // Increment past the country code dash
            curDash1 += 2; 
            curDash2 += 2; 
