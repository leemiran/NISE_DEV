...
public class DMTimeUtility 
{
    ...
    * 
    * @parma iTimeTwo The String representation of a datamodel time interval.
    * 
    * @return A String representing the addition of the two input parameters.
    * 
    */
   static public String add(String iTimeOne, String iTimeTwo)
   {
    ...
    * 
    * @parma ioArray An array of integers.
    * 
    * @return void.
    * 
    */
   static private void timeStringParse(String iTime, int[] ioArray)    
   {
      // P[yY][mM][dD][T[hH][mM][s[.s]S] 
      // P1Y3M2DT3H
      // PT3H5M
