...
public class MasterFormData
{
	...
	private String isMFMenuImg; 	  		// 학습창 하단 메뉴 (이미지 OR 텍스트 여부)
	private String contentCD;				// 컨텐츠 코드
	private String subjGubun;				// 과정구분 ('M': 매월정기안전교육, 'J': JIT) 
	private String mfChat;					// 실시간토론방 사용여부 
	private String cp;					// 컨텐츠 업체코드
	private String contYn;
	private String reasons;
	private String contUrlInfo;

	public String getContUrlInfo() {
		return contUrlInfo;
	}

	public void setContUrlInfo(String contUrlInfo) {
		this.contUrlInfo = contUrlInfo;
	}
	...
	public void setContenttype(String string)
	{
		...
		/*
		try { 
			setContenttypetxt(GetCodenm.get_codenm("0007",string));
		} catch ( Exception e ) { }
		*/
	}
	...
	public String getSubjGubun() {
		return subjGubun;
	}

	public void setSubjGubun(String subjGubun) {
		this.subjGubun = subjGubun;
	}

	public String getMFChat() {
		return mfChat;
	}

	public void setMFChat(String mfChat) {
		this.mfChat = mfChat;
	}
}
