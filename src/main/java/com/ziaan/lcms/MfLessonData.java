...
public class MfLessonData { 
	...
	public void makeSub(MfLessonDataSub ds) { 
		int hsize = objList.size();
		objList.put(String.valueOf(hsize), ds);
	}
	
	public MfLessonDataSub getSub(String oid) { 		// Object List내 특정 Object Return.
		return (MfLessonDataSub)objList.get(oid);
	}
