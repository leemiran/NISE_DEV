...
public class EduListData { 
	...
	private String      stu_page_cnt	 ;
	private String      total_page_cnt	 ;
// 	private String		isbranched       ;
	 ...
	 * @return
	 */
	public String getTotal_page_cnt() { 
	 ...
	 * @param string
	 */
	public void setStu_page_cnt(String string) { 
		stu_page_cnt = string;
	}
	/**
	 * @param string
	 */
	public void setTotal_page_cnt(String string) { 
		total_page_cnt = string;
	}
}
