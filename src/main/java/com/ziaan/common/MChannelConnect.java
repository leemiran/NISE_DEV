...
public class MChannelConnect { 
    ...
    private void initialize(String poolName) throws Exception { 
        try {        	
            ...
            sql += " values (?, ?, ?, ?, ?, ?, ?)";
            // sql += " values ('XG01410','이정한','XG01410','노희성', '테스트','http:// www.ziaan.com','EDU')";
...
/*            pstmt.setString(1, v_seq);
    ...
    */
    public void freeConnection() throws Exception {      
        ...
        count--;
        System.out.println("MfreeConn : " + count + " | " + FormatDate.getDate("yyyy.MM.dd HH:mm:ss") + " | " + FormatDate.getSecDifference(start, FormatDate.getDate("yyyyMMddHHmmss")));
        conn = null;
    }
}
