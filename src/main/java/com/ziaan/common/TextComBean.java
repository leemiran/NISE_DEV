...
public class TextComBean { 
    ...
    public static  String getIsOnOffTxt(String isonoffvalue) throws Exception { 
      ...
      String v_isonofftxt = "";
      if ( isonoffvalue.equals("ON")) v_isonofftxt = "온라인";
      else if ( isonoffvalue.equals("OFF")) v_isonofftxt = "오프라인";
      else v_isonofftxt = "-";
    ...
    */
     public String isGetErrtxt(String errvalue) throws Exception { 
        ...
        if ( errvalue.equals("0") ) { 
          ...
          errtxt = "수료처리가 완료된 과목입니다.";
        }
        else if ( errvalue.equals("23") ) { 
          errtxt = "이미 등록이 완료된 과목입니다.";
        }
    ...
    */
    ...
    public static String getButtonTag(RequestBox box, String btn_type, String btn_text) throws Exception { 
	  return getButtonTag(box, btn_type, btn_text, "");
    }

    public static String getButtonTag(RequestBox box, String btn_type, String btn_text, String btn_href) throws Exception { 
    	//btn_type 
    	//h_1 : 홈페이지 테이블 안쪽
    	//h_2 : 게시판류 입력수정삭제
    	//h_3 : 홈페이지 테이블바깥 검색
        ...
        if(btn_type.equals("h_1")){
        	v_tagstr    = "<table  border=0 cellspacing=0 cellpadding=0><tr><td class=btn021 ></td> ";
        	if(btn_href.equals("")){
        	  v_tagstr   += "<td class=btn022 style=cursor:pointer >"+btn_text+"</td>";
        	}else{
        	  v_tagstr   += "<td class=btn022 style=cursor:pointer onclick=\""+btn_href+"\">"+btn_text+"</td>";
        	}
        	v_tagstr   += "<td class=btn023 ></td></tr></table>";
        }else if(btn_type.equals("h_2")){
        	v_tagstr    = "<table  border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tr><td class=\"btn011\" ></td> ";
        	if(btn_href.equals("")){
        	  v_tagstr   += "<td class=btn022 style=cursor:pointer >"+btn_text+"</td>";
        	}else{
        	  v_tagstr   += "<td class=\"btn012\" style=\"cursor:pointer\" onclick=\""+btn_href+"\">"+btn_text+"</td>";
        	}
        	v_tagstr   += "<td class=\"btn013\" ></td></tr></table>";
        }else if(btn_type.equals("h_3")){
        	v_tagstr    = "<table  border=0 cellspacing=0 cellpadding=0><tr><td class=btn031 ></td> ";
        	if(btn_href.equals("")){
        	  v_tagstr   += "<td class=btn032 style=cursor:pointer >"+btn_text+"</td>";
        	}else{
        	  v_tagstr   += "<td class=btn032 style=cursor:pointer onclick=\""+btn_href+"\">"+btn_text+"</td>";
        	}
        	v_tagstr   += "<td class=btn033 ></td></tr></table>";
        }
