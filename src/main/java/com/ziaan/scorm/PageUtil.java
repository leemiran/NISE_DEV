...
{ 
    ...
    { 
        ...
        endPos = 0;
        SPACE = " ";
        int pCurrentPage = Integer.parseInt(FormatUtil.nvl2(req.getParameter("currentPage"), "1") );
    ...
    { 
        ...
        for ( Enumeration enum1 = req.getParameterNames(); enum1 != null && enum1.hasMoreElements();)
        { 
            param = ((String)enum1.nextElement() ).trim();
    ...
    { 
        ...
        String resultStr = "<select OnChange='goSelectPage(this.value);' > ";
        int count = 0;
