...
//            sql += "       maxsubjcnt ";
            ...
            if ( !v_grcode.equals("") && !v_grcode.equals("ALL")) sql += " and grcode = '" + v_grcode + "'";
            if ( !v_grcode.equals("ALL") && !v_gryear.equals("")) sql += " and gryear = '" + v_gryear + "'";
            if ( !v_grcode.equals("ALL") && !v_grseq.equals("") && !v_grseq.equals("ALL")) sql += " and grseq = '" + v_grseq + "'";
            if ( !v_gubun.equals("ALL"))	sql += " and gubun = '" + v_gubun + "'";
     ...
     public ArrayList SelectStudentList(RequestBox box) throws Exception { 
        ...
        try { 
                ...
                if ( dbox2 != null ) { 
                    ...
                    v_isuse     = dbox2.getString("d_isuse");
