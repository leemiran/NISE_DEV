...
public class PFStatisticsBean {

    // private
    private ConfigSet config;
    private int         row;
    
    public PFStatisticsBean() {
    }
    ...
    */
     public ArrayList performStatistics_03_01_L(RequestBox box) throws Exception { 
        ...
        String              ss_pfcourseyear = box.getStringDefault  ( "s_pfcourseyear"  , "ALL" );  // �⵵
        String              ss_pfcourseseq  = box.getStringDefault  ( "s_pfcourseseq"   , "ALL" );  // ��� ���
        String              ss_pfcourse     = box.getStringDefault  ( "s_pfcourse"      , "ALL" );  // ���&�ڽ�
        ...
        try { 
            ...
            sbSQL.append("                     , MAX(v.CourseYear)  CourseYear                                                                      \n")
                 ...
                 .append("                              ,   c.userid                                                                                \n")
                 .append("                              ,   c.status                                                                                \n")               
                 .append("                          FROM    tz_pfcourseseq  a                                                                       \n")
                 .append("                              ,   tz_pfcourse     b                                                                       \n")
                 .append("                              ,   tz_pfstudent    c                                                                       \n");
            ...
            if ( !ss_pfcourseyear.equals("ALL") ) { 
                sbSQL.append("                          AND     a.courseyear    = " + StringManager.makeSQL(ss_pfcourseyear )   + "                     \n");
            }            
            
            if ( !ss_pfcourse.equals("ALL") ) { 
                sbSQL.append("                          AND     a.CourseCode    = " + StringManager.makeSQL(ss_pfcourse     )   + "                     \n");
            }
            
            if ( !ss_pfcourseseq.equals("ALL") ) { 
                sbSQL.append("                          AND     a.CourseSeq     = " + StringManager.makeSQL(ss_pfcourseseq  )   + "                     \n");
            }
    ...
    */
    public ArrayList performStatistics_03_05_L(RequestBox box) throws Exception {
        ...
        try { 
            ...
            sbSQL.append("                          FROM    tz_pfcourseseq  a                                                                       \n")
                 .append("                              ,   tz_pfcourse     b                                                                       \n")
                 .append("                              ,   tz_pfstudent    c                                                                       \n");
