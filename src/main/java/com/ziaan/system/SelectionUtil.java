...
//// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// ///
	...
	// 교육그룹,연도,기수에 해당하는 과목대분류 Select 문자열을 만든다.(OnChange 이벤트 포함)
	...
	// 교육그룹,연도,기수,과목대분류에 해당하는 코스/코스 Select 문자열을 만든다.(OnChange 이벤트 포함)
	...
	// 교육그룹,연도,기수,과목대분류,과목/코스에 해당하는 과목/코스 기수 Select 문자열을 만든다.(OnChange 이벤트 포함)
...
//// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// ///
  ...
  public static String getGyear(String p_gyear, SelectParam p_param) throws Exception { 
	...
	// 과목대분류  Select 문자열을 만든다.(OnChange 이벤트 포함)
	...
	// 조직본부  Select 문자열을 만든다.(OnChange 이벤트 포함)
	public static String getCompClass(String p_compclass, SelectParam p_param) throws Exception { 	
		RequestBox box = new RequestBox("parambox");
		box.put("p_callmethod", "getCompClass");

		box.put(p_param.getSelectname(), p_compclass);

		SetBoxDefault(box, p_param);

		return getSelectionString(box);
	}
	// 조직  지사  Select 문자열을 만든다.(OnChange 이벤트 포함)
	public static String getJisaClass(String p_compclass, String p_jisaclass, SelectParam p_param) throws Exception { 	
		RequestBox box = new RequestBox("parambox");
		box.put("p_callmethod", "getJisaClass");

		box.put("p_compclass", p_compclass);
		box.put(p_param.getSelectname(), p_jisaclass);
		SetBoxDefault(box, p_param);

		return getSelectionString(box);
	}
	// 조직 팀  Select 문자열을 만든다.(OnChange 이벤트 포함)
	public static String getTeamClass(String p_compclass, String p_jisaclass, String p_teamclass, SelectParam p_param) throws Exception { 	
		RequestBox box = new RequestBox("parambox");
		box.put("p_callmethod", "getTeamClass");

		box.put("p_compclass", p_compclass);
		box.put("p_jisaclass", p_jisaclass);
		box.put(p_param.getSelectname(), p_teamclass);
		SetBoxDefault(box, p_param);

		return getSelectionString(box);
	}
	
	// 부문  Select 문자열을 만든다.(OnChange 이벤트 포함)
	public static String getBumunClass(String p_bumunclass, SelectParam p_param) throws Exception { 	
		RequestBox box = new RequestBox("parambox");
		box.put("p_callmethod", "getBumunClass");
		
		box.put(p_param.getSelectname(), p_bumunclass);
		
		SetBoxDefault(box, p_param);
		
		return getSelectionString(box);
	}
	// 직종  Select 문자열을 만든다.(OnChange 이벤트 포함)
	public static String getJikjongClass(String p_bumunclass, String p_jikjongclass, SelectParam p_param) throws Exception { 	
		RequestBox box = new RequestBox("parambox");
		box.put("p_callmethod", "getJikjongClass");
		
		box.put("p_bumunclass", p_bumunclass);
		box.put(p_param.getSelectname(), p_jikjongclass);
		SetBoxDefault(box, p_param);
		
		return getSelectionString(box);
	}
	// 직무군  Select 문자열을 만든다.(OnChange 이벤트 포함)
	public static String getJikmugunClass(String p_bumunclass, String p_jikjongclass, String p_jikmugunclass, SelectParam p_param) throws Exception { 	
		RequestBox box = new RequestBox("parambox");
		box.put("p_callmethod", "getJikmugunClass");
		
		box.put("p_bumunclass", p_bumunclass);
		box.put("p_jikjongclass", p_jikjongclass);
		box.put(p_param.getSelectname(), p_jikmugunclass);
		SetBoxDefault(box, p_param);
		
		return getSelectionString(box);
	}
	// 직무  Select 문자열을 만든다.(OnChange 이벤트 포함)
	public static String getJikmuClass(String p_bumunclass, String p_jikjongclass, String p_jikmugunclass,String p_jikmuclass, SelectParam p_param) throws Exception { 	
		RequestBox box = new RequestBox("parambox");
		box.put("p_callmethod", "getJikmuClass");
		
		box.put("p_bumunclass", p_bumunclass);
		box.put("p_jikjongclass", p_jikjongclass);
		box.put("p_jikmugunclass", p_jikmugunclass);
		box.put(p_param.getSelectname(), p_jikmuclass);
		SetBoxDefault(box, p_param);
	...
	// 과목중분류  Select 문자열을 만든다.(OnChange 이벤트 포함)
	...
	// 과목소분류  Select 문자열을 만든다.(OnChange 이벤트 포함)
...
//// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// ///
	public static String getSelectionString(RequestBox box) throws Exception {
		...
		String str = "";
		//// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// //// ///
		str = "\r\n" + v_strterm + "<select id=\"" + v_selectname + "\"" + " name=\"" + v_selectname + "\"";
...
// 		box.put("p_allname", Vector);
	...
	public static int getSeq(DBConnectionManager connMgr, Hashtable data) throws Exception { 
		int v_maxno = 0;               
		ListSet             ls      = null;
		String              sql     = "";
		String colname = ""; 
	...
	public static int  getTableCount(Hashtable data) throws Exception {
		int v_cnt = 0;               
		DBConnectionManager connMgr = null;

		try {
			connMgr = new DBConnectionManager();
			v_cnt = getTableCount(connMgr, data);
		}            
	...
	public static int getTableCount(DBConnectionManager connMgr, Hashtable data) throws Exception {
		int v_cnt = 0;               
		ListSet ls = null;
		String sql = "";
		String colname = ""; 
		...
		try {
			...
			//System.out.println("갯수가 몇개냐????????"+sql);
			ls = connMgr.executeQuery(sql);
