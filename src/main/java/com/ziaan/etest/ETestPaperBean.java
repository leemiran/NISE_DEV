    ...
    public int insertETestPaper(RequestBox box) throws Exception {
        ...
        try {
            ...
            while (ls.next()) {
				...
				//System.out.println("v_examnums1=="+v_examnums1);
				String v_wherepaper = "";
       ...
       ArrayList blist = null;
        ...
        try {
	      ...
	      String v_etest = p_etest;
            ...
            sb.append(" <%@ page import = 'com.ziaan.system.*' %>                                           \r\n");
            sb.append(" <%@ page import = 'com.ziaan.library.*' %>                                          \r\n");
            sb.append(" <%@ page import = 'com.ziaan.etest.*' %>                                            \r\n");
            sb.append(" <jsp:useBean id = 'conf' class = 'com.ziaan.library.ConfigSet'  scope = 'page' />   \r\n");
            sb.append(" <%                                                                                  \r\n");
            sb.append("      RequestBox box = null;                                                     \r\n");
            sb.append("      box = RequestManager.getBox(request);       //box = (RequestBox)request.getAttribute(\"requestbox\");                                                   \r\n");
			sb.append("      String v_started = FormatDate.getDate(\"yyyyMMddHHmmss\");                                                        \r\n");
			sb.append("      String v_enddt = \"" + v_enddt + "\";  v_enddt = box.getString(\"p_enddt\"); int v_etesttime = " + v_etesttime + ";                                                       \r\n");
            ...
            sb.append(" <html>                                                                   \r\n");
            sb.append("     <head>                                                                   \r\n");
            sb.append("         <title>::: 오토에버시스템즈 :::</title>                                \r\n");
...
//            sb.append("     <body onLoad='init();begintimer();'>                                                     \r\n");
		    sb.append(" <body leftmargin='0' topmargin='0' bottommargin='0' marginwidth='0' marginheight='0' onLoad='init();begintimer();' oncontextmenu='return false' ondragstart='return false' onselectstart='return false'> ");
    ...
    */
    public Vector getQuestionList(DBConnectionManager connMgr, String p_etestsubj, String p_etesttype, String p_levels) throws Exception {
        ...
        try {
            ...
            sql+= "       a.levels,   a.selcnt,  a.saveimage,   a.saveaudio, a.savemovie, a.saveflash,  a.realimage,   a.realaudio, a.realmovie, a.realflash,DBMS_RANDOM.RANDOM rkey   ";
            sql+= "  from tz_etest   a ";
            sql+= "   where a.etestsubj     = " + SQLString.Format(p_etestsubj);
