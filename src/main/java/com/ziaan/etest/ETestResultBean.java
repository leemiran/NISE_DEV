...
public class ETestResultBean {
    ...
    */
    public ArrayList getResultList(DBConnectionManager connMgr,
                    String p_grcode, String p_gyear, String p_etestsubj, String p_etestcode, String p_userid, String p_gadmin, RequestBox box) throws Exception {
        ...
        try {
            sql = "select '' jikwi,      '' jikwinm, d.userid, '' cono,   d.name, ";
            sql+= "       d.comp asgn,  get_compnm(d.comp,2,2) companynm, '' asgnnm, ";
       ...
       //     sql+= " order by c.etestsubj, c.year, c.etestcode, b.userid ";
            ...
            if(box.getString("p_orderColumn").equals("userid")) {
                ...
                sql+= " order by nvl(c.score, 0) " + box.getString("p_flag");
            }
    ...
    */
    ...
    @return Vector   결과분석 
    */
    public Vector getAverage(DBConnectionManager connMgr, String p_etestsubj, String p_gyear, String p_etestcode ) throws Exception {
						...
						if(isExist < 1){
							...
							*/
							...
							if(tmp_etestnum == v_etestnum){
								...
								isOk = DeleteTZ_examresult(connMgr,
								v_etestsubj,     v_year,   v_etestcode,  tmp_etestnum,  v_userid, v_etest, v_etestcnt, v_etestpoint, v_score, v_answercnt, v_started, v_ended, v_time, v_answer, v_corrected, v_luserid);
								if(isOk > 0){
									isOk = InsertTZ_examresult(connMgr,
									v_etestsubj,     v_year,   v_etestcode,  v_etestnum,  v_userid, v_etest, v_etestcnt, v_etestpoint, v_score, v_answercnt, v_started, v_ended, v_time, v_answer, v_corrected, v_luserid);
								}
    ...
    public int InsertTZ_examresult(DBConnectionManager connMgr,
  	...
  	public int UpdateTZ_examresult(DBConnectionManager connMgr,
        ...
        return isOk;
      	...
      	public int DeleteTZ_examresult(DBConnectionManager connMgr,
                                String p_etestsubj,     String p_year,      String p_etestcode, int p_etestnum,
                                String p_userid,  String p_etest, int p_etestcnt, 
		                        int p_etestpoint,  int p_score, int p_answercnt,  String p_started,  String p_ended,  double p_time,
                                String p_answer, String p_corrected,   String p_luserid) throws Exception {
    ...
    */
    public ArrayList getGubunResult(DBConnectionManager connMgr, String p_etestsubj, String p_year, String p_etestcode, String p_userid) throws Exception {
        ...
        try {
            ...
            // 문제당배점, 문제조합(번호), 정답여부
            sql = "select  a.etestpoint, b.etest,  b.corrected ";
    ...
    public Vector SelectGubunResult(RequestBox box) throws Exception {
        ...
        try {
            ...
            if(p_print.equals("1")){ // 개인일때..       
        		...
        		a_list = getGubunResult(connMgr, v_etestsubj, v_year, v_etestcode, v_userid);   
        		v_etestgubun.add(a_list);				
        			
		    }else{
                sql = " select userid, (select name from tz_member where userid=tz_etestresult.userid) name "
                    + " from tz_etestresult where etestsubj = '"+v_etestsubj+"' and year = '"+v_year+"' and etestcode = '"+v_etestcode+"' ";
    ...
    */    
    public String[] getEtestmasterCode(String etestsubj) throws Exception {
        ...
        try {
            ...
            sql = " select etestcode from TZ_ETESTMASTER "
                + " where etestsubj in (select etestsubj from TZ_ETESTMASTER group by etestsubj having count(etestcode) < 4) and etestsubj='"+etestsubj+"' ";
            ...
            if (v_action.equals("go")) {
                ...
                while (ls.next()) {
                    ...
                    while(st1.hasMoreElements()) {
        				...
        				rs = pstmt.executeQuery();
        				if (rs.next()) { s_etesttype = rs.getString("etesttype"); };
